...
*/
(function(){function na(k,m){k.prototype=db(m.prototype);k.prototype.constructor=k;k.base=m.prototype}function db(k){function m(){}m.prototype=k;return new m}function Wa(k,m,w){"millisecond"===w?k.setMilliseconds(k.getMilliseconds()+1*m):"second"===w?k.setSeconds(k.getSeconds()+1*m):"minute"===w?k.setMinutes(k.getMinutes()+1*m):"hour"===w?k.setHours(k.getHours()+1*m):"day"===w?k.setDate(k.getDate()+1*m):"week"===w?k.setDate(k.getDate()+7*m):"month"===w?k.setMonth(k.getMonth()+1*m):"year"===w&&k.setFullYear(k.getFullYear()+
1*m);return k}function W(k,m){var w=!1;0>k&&(w=!0,k*=-1);k=""+k;for(m=m?m:1;k.length<m;)k="0"+k;return w?"-"+k:k}function Fa(k){if(!k)return k;k=k.replace(/^\s\s*/,"");for(var m=/\s/,w=k.length;m.test(k.charAt(--w)););return k.slice(0,w+1)}function Ba(k){k.roundRect=function(k,w,r,t,qa,D,y,E){y&&(this.fillStyle=y);E&&(this.strokeStyle=E);"undefined"===typeof qa&&(qa=5);this.lineWidth=D;this.beginPath();this.moveTo(k+qa,w);this.lineTo(k+r-qa,w);this.quadraticCurveTo(k+r,w,k+r,w+qa);this.lineTo(k+r,
w+t-qa);this.quadraticCurveTo(k+r,w+t,k+r-qa,w+t);this.lineTo(k+qa,w+t);this.quadraticCurveTo(k,w+t,k,w+t-qa);this.lineTo(k,w+qa);this.quadraticCurveTo(k,w,k+qa,w);this.closePath();y&&this.fill();E&&0<D&&this.stroke()}}function Qa(k,m){return k-m}function R(k){var m=((k&16711680)>>16).toString(16),w=((k&65280)>>8).toString(16);k=((k&255)>>0).toString(16);m=2>m.length?"0"+m:m;w=2>w.length?"0"+w:w;k=2>k.length?"0"+k:k;return"#"+m+w+k}function eb(k,m){var w=this.length>>>0,r=Number(m)||0,r=0>r?Math.ceil(r):
Math.floor(r);for(0>r&&(r+=w);r<w;r++)if(r in this&&this[r]===k)return r;return-1}function r(k){return null===k||"undefined"===typeof k}function Ca(k){k.indexOf||(k.indexOf=eb);return k}function fb(k){if(J.fSDec)k[X("`eeDwdouMhrudods")](X("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){J._fTWm&&J._fTWm(k)})}function Xa(k,m,w){w=w||"normal";var r=k+"_"+m+"_"+w,t=Ya[r];if(isNaN(t)){try{k="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
k+"; font-size:"+m+"px; font-weight:"+w+";";if(!va){var qa=document.body;va=document.createElement("span");va.innerHTML="";var D=document.createTextNode("Mpgyi");va.appendChild(D);qa.appendChild(va)}va.style.display="";va.setAttribute("style",k);t=Math.round(va.offsetHeight);va.style.display="none"}catch(y){t=Math.ceil(1.1*m)}t=Math.max(t,m);Ya[r]=t}return t}function O(k,m){var w=[];if(w={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,
2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[k||"solid"])for(var r=0;r<w.length;r++)w[r]*=m;else w=[];return w}function Q(k,m,w,t,y){t=t||[];y=r(y)?gb?{passive:!1,capture:!1}:!1:y;t.push([k,m,w,y]);return k.addEventListener?(k.addEventListener(m,w,y),w):k.attachEvent?(t=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};w.call(k,m)},k.attachEvent("on"+
m,t),t):!1}function hb(k){if(k._menuButton)k.exportEnabled?Ka(k._menuButton):ta(k._menuButton);else if(k.exportEnabled&&t){var m=!1;k._menuButton=document.createElement("button");ua(k,k._menuButton,"menu");k._toolBar.appendChild(k._menuButton);Q(k._menuButton,"touchstart",function(k){m=!0},k.allDOMEventHandlers);Q(k._menuButton,"click",function(){"none"!==k._dropdownMenu.style.display||k._dropDownCloseTime&&500>=(new Date).getTime()-k._dropDownCloseTime.getTime()||(k._dropdownMenu.style.display="block",
k._menuButton.blur(),k._dropdownMenu.focus())},k.allDOMEventHandlers,!0);Q(k._menuButton,"mouseover",function(){m||(oa(k._menuButton,{backgroundColor:k.toolbar.backgroundColorOnHover,color:k.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&oa(k._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},k.allDOMEventHandlers,!0);Q(k._menuButton,"mouseout",function(){m||(oa(k._menuButton,{backgroundColor:k.toolbar.backgroundColor,color:k.toolbar.fontColor}),0>=
navigator.userAgent.search("MSIE")&&oa(k._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},k.allDOMEventHandlers,!0)}if(!k._dropdownMenu&&k.exportEnabled&&t){m=!1;k._dropdownMenu=document.createElement("div");k._dropdownMenu.setAttribute("tabindex",-1);var w=-1!==k.theme.indexOf("dark")?"black":"#888888";k._dropdownMenu.style.cssText="position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:"+
k.toolbar.backgroundColor+";box-shadow: 2px 2px 10px "+w;k._dropdownMenu.style.display="none";k._toolBar.appendChild(k._dropdownMenu);Q(k._dropdownMenu,"blur",function(){ta(k._dropdownMenu);k._dropDownCloseTime=new Date},k.allDOMEventHandlers,!0);w=document.createElement("div");w.style.cssText="padding: 12px 8px 12px 8px";w.innerHTML=k._cultureInfo.printText;w.style.backgroundColor=k.toolbar.backgroundColor;w.style.color=k.toolbar.fontColor;k._dropdownMenu.appendChild(w);Q(w,"touchstart",function(k){m=
!0},k.allDOMEventHandlers);Q(w,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColorOnHover,this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0);Q(w,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,!0);Q(w,"click",function(){k.print();ta(k._dropdownMenu)},k.allDOMEventHandlers,!0);w=document.createElement("div");w.style.cssText="padding: 12px 8px 12px 8px";w.innerHTML=
k._cultureInfo.saveJPGText;w.style.backgroundColor=k.toolbar.backgroundColor;w.style.color=k.toolbar.fontColor;k._dropdownMenu.appendChild(w);Q(w,"touchstart",function(k){m=!0},k.allDOMEventHandlers);Q(w,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColorOnHover,this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0);Q(w,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,
!0);Q(w,"click",function(){k.exportChart({format:"jpeg",fileName:k.exportFileName});ta(k._dropdownMenu)},k.allDOMEventHandlers,!0);w=document.createElement("div");w.style.cssText="padding: 12px 8px 12px 8px";w.innerHTML=k._cultureInfo.savePNGText;w.style.backgroundColor=k.toolbar.backgroundColor;w.style.color=k.toolbar.fontColor;k._dropdownMenu.appendChild(w);Q(w,"touchstart",function(k){m=!0},k.allDOMEventHandlers);Q(w,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColorOnHover,
this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0);Q(w,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,!0);Q(w,"click",function(){k.exportChart({format:"png",fileName:k.exportFileName});ta(k._dropdownMenu)},k.allDOMEventHandlers,!0)}}function Za(k,m,w){k*=ga;m*=ga;k=w.getImageData(k,m,2,2).data;m=!0;for(w=0;4>w;w++)if(k[w]!==k[w+4]|k[w]!==k[w+8]|k[w]!==k[w+12]){m=!1;break}return m?k[0]<<
16|k[1]<<8|k[2]:0}function ka(k,m,w){return k in m?m[k]:w[k]}function La(k,m,w){if(t&&$a){var r=k.getContext("2d");Ma=r.webkitBackingStorePixelRatio||r.mozBackingStorePixelRatio||r.msBackingStorePixelRatio||r.oBackingStorePixelRatio||r.backingStorePixelRatio||1;ga=Ra/Ma;k.width=m*ga;k.height=w*ga;Ra!==Ma&&(k.style.width=m+"px",k.style.height=w+"px",r.scale(ga,ga))}else k.width=m,k.height=w}function ib(k){if(!jb){var m=!1,w=!1;"undefined"===typeof pa.Chart.creditHref?(k.creditHref=X("iuuqr;..b`ow`rkr/bnl."),
k.creditText=X("B`ow`rKR/bnl")):(m=k.updateOption("creditText"),w=k.updateOption("creditHref"));if(k.creditHref&&k.creditText){k._creditLink||(k._creditLink=document.createElement("a"),k._creditLink.setAttribute("class","canvasjs-chart-credit"),k._creditLink.setAttribute("title","JavaScript Charts"),k._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(k.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
k._creditLink.setAttribute("tabIndex",-1),k._creditLink.setAttribute("target","_blank"));if(0===k.renderCount||m||w)k._creditLink.setAttribute("href",k.creditHref),k._creditLink.innerHTML=k.creditText;k._creditLink&&k.creditHref&&k.creditText?(k._creditLink.parentElement||k._canvasJSContainer.appendChild(k._creditLink),k._creditLink.style.top=k.height-14+"px"):k._creditLink.parentElement&&k._canvasJSContainer.removeChild(k._creditLink)}}}function sa(k,m){Ga&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
...
"Arial",Ea=t?"Impact, Charcoal, sans-serif":"Arial",ya={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},H,$,Z,ca,ha;$="#333333";Z="#000000";H="#666666";
ha=ca="#000000";var T=20,E=14,Va={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Ea,fontSize:32,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ea,fontSize:E,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,indexLabelFontSize:E,indexLabelFontColor:$,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,
labelFontSize:E,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ha,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",
lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",
labelFontWeight:"normal",labelBackgroundColor:ha,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",
labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ha,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Z,labelFontWeight:"normal",
lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ha,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],legend:{fontFamily:y,
fontSize:14,fontColor:$,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1}};Z=$="#F5F5F5";H="#FFFFFF";ca="#40BAF1";ha="#F5F5F5";var T=20,E=14,ab={colorSet:"colorSet2",title:{fontFamily:y,fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:y,fontSize:E,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,
indexLabelFontSize:E,indexLabelFontColor:"#666666",indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:T,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickThickness:1,tickColor:"#BBBBBB",gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,
color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",
...
titleFontSize:T,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",
labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:E,
...
labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:y,fontSize:14,fontColor:$,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:Z,backgroundColor:"rgba(0, 0, 0, .7)"}},theme1:Va,
theme2:ab,theme3:Va},S={numberDuration:1,yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){J.fSDec=function(k){for(var m="",w=0;w<k.length;w++)m+=String.fromCharCode(k[w]-111);return m};J.str={ncv:[189,222,221,156,178,222,220,220,212,225,210,216,208,219,143,197,212,225,226,216,222,221],fntStr:[223,
...
227])][J.fSDec([210,225,212,211,216,227,183,225,212,213])];J.pro={sCH:pa[J.fSDec([178,215,208,225,227])][J.fSDec([210,225,212,211,216,227,183,225,212,213])]};J._fTWm=function(k){if("undefined"===typeof J.pro.sCH&&!cb){var m=k[J.fSDec(J.str.ct)];m[J.fSDec(J.str.tBl)]=J.fSDec(J.str.tp);m[J.fSDec(J.str.fnt)]=11+J.fSDec(J.str.fntStr);m[J.fSDec(J.str.fSy)]=J.fSDec(J.str.gr);m[J.fSDec(J.str.fTx)](J.fSDec(J.str.ncv),2,k.height-11-2)}}})();var gb=function(){var k=!1;try{var m=Object.defineProperty&&Object.defineProperty({},
"passive",{get:function(){k=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(w){k=!1}return k}(),Ya={},va=null,lb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},mb=function(k,m,w){m=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=m?12:11,Math.round(m*(k/400)))},za=function(){var k=
...
D=/[^-+\dA-Z]/g;return function(E,O,N){var H=N?N.days:m,R=N?N.months:r,Q=N?N.shortDays:w,S=N?N.shortMonths:t;N="";var J=!1;E=E&&E.getTime?E:E?new Date(E):new Date;if(isNaN(E))throw SyntaxError("invalid date");"UTC:"===O.slice(0,4)&&(O=O.slice(4),J=!0);N=J?"getUTC":"get";var U=E[N+"Date"](),L=E[N+"Day"](),V=E[N+"Month"](),a=E[N+"FullYear"](),d=E[N+"Hours"](),c=E[N+"Minutes"](),b=E[N+"Seconds"](),e=E[N+"Milliseconds"](),f=J?0:E.getTimezoneOffset();return N=O.replace(k,function(l){switch(l){case "D":return U;
case "DD":return W(U,2);case "DDD":return Q[L];case "DDDD":return H[L];case "M":return V+1;case "MM":return W(V+1,2);case "MMM":return S[V];case "MMMM":return R[V];case "Y":return parseInt(String(a).slice(-2));case "YY":return W(String(a).slice(-2),2);case "YYY":return W(String(a).slice(-3),3);case "YYYY":return W(a,4);case "h":return d%12||12;case "hh":return W(d%12||12,2);case "H":return d;case "HH":return W(d,2);case "m":return c;case "mm":return W(c,2);case "s":return b;case "ss":return W(b,2);
case "f":return String(e).slice(0,1);case "ff":return W(String(e).slice(0,2),2);case "fff":return W(String(e).slice(0,3),3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return J?"UTC":(String(E).match(y)||[""]).pop().replace(D,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2)+W(Math.abs(f)%
60,2);default:return l.slice(1,l.length-1)}})}}(),da=function(k,m,w){if(null===k)return"";if(!isFinite(k))return k;k=Number(k);var r=0>k?!0:!1;r&&(k*=-1);var t=w?w.decimalSeparator:".",y=w?w.digitGroupSeparator:",",D="";m=String(m);var D=1,E=w="",O=-1,N=[],H=[],R=0,J=0,Q=0,S=!1,U=0,E=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var L=0;E&&L<E.length;L++)if(m=E[L],"."===m&&0>O)O=L;else{if("%"===m)D*=100;else if("\u2030"===m){D*=1E3;continue}else if(","===m[0]&&"."===m[m.length-
1]){D/=Math.pow(1E3,m.length-1);O=L+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(S=!0);0>O?(N.push(m),"#"===m||"0"===m?R++:","===m&&Q++):(H.push(m),"#"!==m&&"0"!==m||J++)}S&&(m=Math.floor(k),E=-Math.floor(Math.log(k)/Math.LN10+1),U=0===k?0:0===m?-(R+E):String(m).length-R,D/=Math.pow(10,U));0>O&&(O=L);D=(k*D).toFixed(J);m=D.split(".");D=(m[0]+"").split("");k=(m[1]+"").split("");D&&"0"===D[0]&&D.shift();for(S=E=L=J=O=0;0<N.length;)if(m=N.pop(),"#"===m||"0"===m)if(O++,O===R){var V=
D,D=[];if("0"===m)for(m=R-J-(V?V.length:0);0<m;)V.unshift("0"),m--;for(;0<V.length;)w=V.pop()+w,S++,0===S%E&&(L===Q&&0<V.length)&&(w=y+w)}else 0<D.length?(w=D.pop()+w,J++,S++):"0"===m&&(w="0"+w,J++,S++),0===S%E&&(L===Q&&0<D.length)&&(w=y+w);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(L++,E=S,S=0,0<D.length&&(w=y+w)):w=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+w:m+w:(m=0>U?m.replace("+","").replace("-",
""):m.replace("-",""),w+=m.replace(/[0]+/,function(a){return W(U,a.length)}));y="";for(N=!1;0<H.length;)m=H.shift(),"#"===m||"0"===m?0<k.length&&0!==Number(k.join(""))?(y+=k.shift(),N=!0):"0"===m&&(y+="0",N=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?y+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?y+=m:(m=0>U?m.replace("+","").replace("-",""):m.replace("-",""),y+=m.replace(/[0]+/,function(a){return W(U,a.length)}));
w+=(N?t:"")+y;return r?"-"+w:w},Na=function(k){var m=0,w=0;k=k||window.event;k.offsetX||0===k.offsetX?(m=k.offsetX,w=k.offsetY):k.layerX||0==k.layerX?(m=k.layerX,w=k.layerY):(m=k.pageX-k.target.offsetLeft,w=k.pageY-k.target.offsetTop);return{x:m,y:w}},$a=!0,Ra=window.devicePixelRatio||1,Ma=1,ga=$a?Ra/Ma:1,ba=function(k,m,w,r,t,y,D,E,O,N,S,R,H){"undefined"===typeof H&&(H=1);D=D||0;E=E||"black";var J=15<r-m&&15<t-w?8:0.35*Math.min(r-m,t-w);k.beginPath();k.moveTo(m,w);k.save();k.fillStyle=y;k.globalAlpha=
H;k.fillRect(m,w,r-m,t-w);k.globalAlpha=1;0<D&&(H=0===D%2?0:0.5,k.beginPath(),k.lineWidth=D,k.strokeStyle=E,k.moveTo(m,w),k.rect(m-H,w-H,r-m+2*H,t-w+2*H),k.stroke());k.restore();!0===O&&(k.save(),k.beginPath(),k.moveTo(m,w),k.lineTo(m+J,w+J),k.lineTo(r-J,w+J),k.lineTo(r,w),k.closePath(),D=k.createLinearGradient((r+m)/2,w+J,(r+m)/2,w),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, .4)"),k.fillStyle=D,k.fill(),k.restore());!0===N&&(k.save(),k.beginPath(),k.moveTo(m,t),k.lineTo(m+J,t-J),k.lineTo(r-
J,t-J),k.lineTo(r,t),k.closePath(),D=k.createLinearGradient((r+m)/2,t-J,(r+m)/2,t),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, .4)"),k.fillStyle=D,k.fill(),k.restore());!0===S&&(k.save(),k.beginPath(),k.moveTo(m,w),k.lineTo(m+J,w+J),k.lineTo(m+J,t-J),k.lineTo(m,t),k.closePath(),D=k.createLinearGradient(m+J,(t+w)/2,m,(t+w)/2),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=D,k.fill(),k.restore());!0===R&&(k.save(),k.beginPath(),k.moveTo(r,w),k.lineTo(r-J,
w+J),k.lineTo(r-J,t-J),k.lineTo(r,t),D=k.createLinearGradient(r-J,(t+w)/2,r,(t+w)/2),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=D,D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=D,k.fill(),k.closePath(),k.restore())},X=function(k){for(var m="",r=0;r<k.length;r++)m+=String.fromCharCode(Math.ceil(k.length/57/5)^k.charCodeAt(r));return m},cb=window&&window[X("mnb`uhno")]&&window[X("mnb`uhno")].href&&window[X("mnb`uhno")].href.indexOf&&(-1!==
...
U.prototype.setOptions=function(k,m){if(pa[this._defaultsKey]){var r=pa[this._defaultsKey],t;for(t in r)"publicProperties"!==t&&r.hasOwnProperty(t)&&(this[t]=k&&t in k?k[t]:m&&t in m?m[t]:r[t])}else Ga&&window.console&&console.log("defaults not set")};U.prototype.get=function(k){var m=pa[this._defaultsKey];if("options"===k)return this.options&&this.options._isPlaceholder?null:this.options;if(m.hasOwnProperty(k)||m.publicProperties&&m.publicProperties.hasOwnProperty(k))return this[k];window.console&&
window.console.log('Property "'+k+"\" doesn't exist. Please check for typo.")};U.prototype.set=function(k,m,r){r="undefined"===typeof r?!0:r;var t=pa[this._defaultsKey];if("options"===k)this.createUserOptions(m);else if(t.hasOwnProperty(k)||t.publicProperties&&t.publicProperties.hasOwnProperty(k)&&"readWrite"===t.publicProperties[k])this.options._isPlaceholder&&this.createUserOptions(),this.options[k]=m;else{window.console&&(t.publicProperties&&t.publicProperties.hasOwnProperty(k)&&"readOnly"===t.publicProperties[k]?
window.console.log('Property "'+k+'" is read-only.'):window.console.log('Property "'+k+"\" doesn't exist. Please check for typo."));return}r&&(this.stockChart||this.chart||this).render()};U.prototype.addTo=function(k,m,r,t){t="undefined"===typeof t?!0:t;var y=pa[this._defaultsKey];y.hasOwnProperty(k)||y.publicProperties&&y.publicProperties.hasOwnProperty(k)&&"readWrite"===y.publicProperties[k]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[k]&&(this.options[k]=
...
m=r):m=void 0,k[m]=this.options};U.prototype.remove=function(k){k="undefined"===typeof k?!0:k;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Ca(m);var r=m.indexOf(this.options);0<=r&&m.splice(r,1)}else delete this.parent.options[this.optionsName];k&&(this.stockChart||this.chart||this).render()};U.prototype.updateOption=function(k){!pa[this._defaultsKey]&&(Ga&&window.console)&&console.log("defaults not set");var m=pa[this._defaultsKey],t={},y=this[k],E=this._themeOptionsKey,
J=this._index;this.theme&&r(this.parent)&&r(E)&&r(J)?t=r(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[E])&&(null===J?t=this.parent.themeOptions[E]:0<this.parent.themeOptions[E].length&&(t=Math.min(this.parent.themeOptions[E].length-1,J),t=this.parent.themeOptions[E][t]));this.themeOptions=t;k in m&&(y=k in this.options?this.options[k]:t&&k in t?t[k]:m[k]);if(y===this[k])return!1;this[k]=
...
if(r<m)t=E+1;else if(r>m)y=E-1;else break}r>m&&1<D.length&&(D=D.substr(0,D.length-1),r=this.ctx.measureText(D).width);m=!0;if(D.length===k.length||" "===k[D.length])m=!1;m&&(k=D.split(" "),1<k.length&&k.pop(),D=k.join(" "),r=this.ctx.measureText(D).width);return{text:D,width:r}};ia.prototype._wrapText=function(){var k=new String(Fa(String(this.text))),m=[],r=this.ctx.font,t=0,y=0;this.ctx.font=this._getFontString();if(0===this.frontSize)y=t=0;else for(;0<k.length;){var E=this.maxHeight-(this.topPadding+
this.bottomPadding),D=this._getLineWithWidth(k,this.maxWidth-(this.leftPadding+this.rightPadding),!1);D.height=this._lineHeight;m.push(D);var J=y,y=Math.max(y,D.width),t=t+D.height,k=Fa(k.slice(D.text.length,k.length));E&&t>E&&(D=m.pop(),t-=D.height,y=J)}this._wrappedText={lines:m,width:y,height:t};this.width=y+(this.leftPadding+this.rightPadding);this.height=t+(this.topPadding+this.bottomPadding);this.ctx.font=r};ia.prototype._getFontString=function(){var k;k=""+(this.fontStyle?this.fontStyle+" ":
"");k+=this.fontWeight?this.fontWeight+" ":"";k+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!t&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return k+=m};na(Ta,U);na(xa,U);xa.prototype.setLayout=function(){if(this.text){var k=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=k.layoutManager.getFreeSpace(),t=m.x1,y=m.y1,E=0,J=0,D=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,O,H;"top"===this.verticalAlign||
"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=m.width-4-D*("center"===this.horizontalAlign?2:1)),J=0.5*m.height-this.margin-2,E=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=m.height-4),J=0.5*m.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=m.width-4),J=0.5*m.height-4));var N;r(this.padding)||"number"!==typeof this.padding?r(this.padding)||"object"!==
...
backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:J,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"top"});N=J.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(y=m.y1+2,H="top"):"bottom"===this.verticalAlign&&(y=m.y2-2-N.height,H="bottom"),"left"===this.horizontalAlign?t=m.x1+2:"center"===this.horizontalAlign?t=m.x1+m.width/2-N.width/2:"right"===this.horizontalAlign&&(t=m.x2-2-N.width-D),O=this.horizontalAlign,
this.width=N.width,this.height=N.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(t=m.x1+2,y=m.y2-2-(this.maxWidth/2-N.width/2),E=-90,H="left",this.width=N.height,this.height=N.width):"right"===this.horizontalAlign?(t=m.x2-2,y=m.y1+2+(this.maxWidth/2-N.width/2),E=90,H="right",this.width=N.height,this.height=N.width):"center"===this.horizontalAlign&&(y=k.y1+(k.height/2-N.height/2),t=k.x1+(k.width/2-N.width/2),H="center",this.width=N.width,this.height=N.height),O="center");J.x=
t;J.y=y;J.angle=E;J.horizontalAlign=O;this._textBlock=J;k.layoutManager.registerSpace(H,{width:this.width+("left"===H||"right"===H?this.margin+2:0),height:this.height+("top"===H||"bottom"===H?this.margin+2:0)});this.bounds={x1:t,y1:y,x2:t+this.width,y2:y+this.height};this.ctx.textBaseline="top"}};xa.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};na(Ha,U);Ha.prototype.setLayout=xa.prototype.setLayout;Ha.prototype.render=xa.prototype.render;Ua.prototype.get=function(k,m){var t=
null;0<this.pool.length?(t=this.pool.pop(),La(t,k,m)):t=sa(k,m);return t};Ua.prototype.release=function(k){this.pool.push(k)};na(Ia,U);var Oa={addTheme:function(k,m){bb[k]=m},addColorSet:function(k,m){ya[k]=m},addCultureInfo:function(k,m){Ja[k]=m},formatNumber:function(k,m,t){t=t||"en";if(Ja[t])return da(k,m||"#,##0.##",new Ia(t));throw"Unknown Culture Name";},formatDate:function(k,m,t){t=t||"en";if(Ja[t])return za(k,m||"DD MMM YYYY",new Ia(t));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
...
h=1;p=A?Math.abs(e-c):Math.abs(b-d);p=0<l.trimLength?Math.abs(p*l.trimLength/100):Math.abs(p-l.length);A?(c+=p/2,e-=p/2):(d+=p/2,b-=p/2);var p=1===Math.round(l.thickness)%2?0.5:0,n=1===Math.round(u.thickness)%2?0.5:0;a.save();a.globalAlpha=h;a.strokeStyle=u.color||f;a.lineWidth=u.thickness||2;a.setLineDash&&a.setLineDash(O(u.dashType,u.thickness));a.beginPath();A&&0<u.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-n),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-n)):0<u.thickness&&(a.moveTo(Math.round((d+
b)/2)-n,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-n,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(O(l.dashType,l.thickness));a.beginPath();A&&0<l.thickness?(a.moveTo(b-p,c),a.lineTo(b-p,e),a.moveTo(d+p,c),a.lineTo(d+p,e)):0<l.thickness&&(a.moveTo(d,c+p),a.lineTo(b,c+p),a.moveTo(d,e-p),a.lineTo(b,e-p));a.stroke();a.restore()}function E(a,d){E.base.constructor.call(this,"Legend","legend",d,null,a);this.chart=a;this.canvas=a.canvas;
...
new Ia(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&t;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");if(this.options.zoomEnabled||this.panEnabled){if(!this._zoomButton){var d=!1;ta(this._zoomButton=document.createElement("button"));ua(this,this._zoomButton,"pan");this._toolBar.appendChild(this._zoomButton);
...
height:this.height};a=!0}else a=!1;return a};m.prototype._initialize=function(){this.isNavigator=r(this.parent)||r(this.parent._defaultsKey)||"Navigator"!==this.parent._defaultsKey?!1:!0;this.toolbar=new Ta(this,this.options.toolbar);this._animator?this._animator.cancelAllAnimations():this._animator=new ha(this);this.removeAllEventListeners();this.disableToolTip=!1;this._axes=[];this.funnelPyramidClickHandler=this.pieDoughnutClickHandler=null;this._updateOptions();this.animatedRender=t&&this.animationEnabled&&
...
for(var h=0;h<u.dataSeriesIndexes.length;h++)this._dataInRenderedOrder.push(this.data[u.dataSeriesIndexes[h]]);this.animatedRender&&(u.targetCanvasCtx.miterLimit=e,A&&c.push(A))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&c.push({source:this._breaksCanvasCtx,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7});this.animatedRender&&0<this._indexLabels.length&&(e=sa(this.width,this.height).getContext("2d"),
...
(a.axisX.labels[b]=n.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===n.dataPoints[q].y?c.viewPortMin===b&&k<b&&(c.viewPortMin=k):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,A=Math.min(e,A)):u[b]?u[b]+=e:(u[b]=e,h=Math.max(e,h)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?
(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,u)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=u));n.axisX.valueType=n.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,A)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,A)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in u)u.hasOwnProperty(q)&&!isNaN(q)&&
(a=u[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,h)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,h))))}};m.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=!1,u=!1,A=[],h=0;h<a.dataSeriesIndexes.length;h++){var p=this.data[a.dataSeriesIndexes[h]],n=0,q=!1,g=!1,v;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var k=
...
1].x,0>s&&(s*=-1),c.minDiff>s&&0!==s&&(c.minDiff=s);r(e)||null===p.dataPoints[n-1].y||(a.axisY.logarithmic?0<e&&(s=e/p.dataPoints[n-1].y,1>s&&(s=1/s),d.minDiff>s&&1!==s&&(d.minDiff=s)):(s=e-p.dataPoints[n-1].y,0>s&&(s*=-1),d.minDiff>s&&0!==s&&(d.minDiff=s)))}if(b<k&&!q)null!==e&&(v=b);else{if(!q&&(q=!0,0<n)){n-=2;continue}if(b>fa&&!g)g=!0;else if(b>fa&&g)continue;p.dataPoints[n].label&&(a.axisX.labels[b]=p.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);
null===e?c.viewPortMin===b&&v<b&&(c.viewPortMin=v):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(u=!0),A[b]=A[b]?A[b]+Math.abs(e):Math.abs(e))}}p.axisX.valueType=p.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=r(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=r(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!u?(d.max=r(d.viewPortMax)?
...
c=a.axisX.dataInfo,b,e,f,l,u=!1,A=0;A<a.dataSeriesIndexes.length;A++){var h=this.data[a.dataSeriesIndexes[A]],p=0,n=!1,q=!1,g,v,k;if("normal"===h.axisPlacement||"xySwapped"===h.axisPlacement)var fa=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,s=a.axisX.sessionVariables.newViewportMaximum?
a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(h.dataPoints[p].x&&h.dataPoints[p].x.getTime||"dateTime"===h.xValueType)u=!0;for(p=0;p<h.dataPoints.length;p++){"undefined"===typeof h.dataPoints[p].x&&(h.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));h.dataPoints[p].x.getTime?(u=!0,b=h.dataPoints[p].x.getTime()):b=h.dataPoints[p].x;
...
h.dataPoints[p-1].y[0],1>v&&(v=1/v),d.minDiff>v&&1!==v&&(d.minDiff=v)):(v=e[0]-h.dataPoints[p-1].y[0],0>v&&(v*=-1),d.minDiff>v&&0!==v&&(d.minDiff=v))));if(!(b<fa)||n){if(!n&&(n=!0,0<p)){p-=2;g=k;continue}if(b>s&&!q)q=!0;else if(b>s&&q)continue;h.dataPoints[p].label&&(a.axisX.labels[b]=h.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(x=0;x<e.length;x++)if(null===e[x]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&
(c.viewPortMin=g):(f<d.viewPortMin&&(d.viewPortMin=f),l>d.viewPortMax&&(d.viewPortMax=l))}}h.axisX.valueType=h.xValueType=u?"dateTime":"number"}};m.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var u=this.data[a.dataSeriesIndexes[l]],A=0,h=!1,p=!1,n=b=0;if("normal"===u.axisPlacement||"xySwapped"===u.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?
...
n,u.dataPointEOs[A].cumulativeSum=0===A?0:u.dataPointEOs[A-1].cumulativeSum,u.dataPoints[A].y=0===A?0:b,n=0===A?0:u.dataPointEOs[A-1].cumulativeSum,b=0):(e="number"!==typeof u.dataPoints[A].y?0:u.dataPoints[A].y,u.dataPointEOs[A].cumulativeSumYStartValue=0===A?0:u.dataPointEOs[A-1].cumulativeSum,u.dataPointEOs[A].cumulativeSum=0===A?e:u.dataPointEOs[A-1].cumulativeSum+e,b+=e);for(A=0;A<u.dataPoints.length;A++)if("undefined"===typeof u.dataPoints[A].x&&(u.dataPoints[A].x=A+(a.axisX.logarithmic?1:0)),
u.dataPoints[A].x.getTime?(f=!0,b=u.dataPoints[A].x.getTime()):b=u.dataPoints[A].x,e=u.dataPoints[A].y,b<c.min&&(c.min=b),b>c.max&&(c.max=b),u.dataPointEOs[A].cumulativeSum<d.min&&(d.min=u.dataPointEOs[A].cumulativeSum),u.dataPointEOs[A].cumulativeSum>d.max&&(d.max=u.dataPointEOs[A].cumulativeSum),0<A&&(a.axisX.logarithmic?(n=b/u.dataPoints[A-1].x,1>n&&(n=1/n),c.minDiff>n&&1!==n&&(c.minDiff=n)):(n=b-u.dataPoints[A-1].x,0>n&&(n*=-1),c.minDiff>n&&0!==n&&(c.minDiff=n)),null!==e&&null!==u.dataPoints[A-
1].y&&(a.axisY.logarithmic?(e=u.dataPointEOs[A].cumulativeSum/u.dataPointEOs[A-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=u.dataPointEOs[A].cumulativeSum-u.dataPointEOs[A-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||h){if(!h&&(h=!0,0<A)){A-=2;continue}if(b>g&&!p)p=!0;else if(b>g&&p)continue;u.dataPoints[A].label&&(a.axisX.labels[b]=u.dataPoints[A].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<A&&(u.dataPointEOs[A-
...
b=(this._axes[l].dataInfo.max+1-A)*Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10)/100;var h=this._axes[l].dataInfo._dataRanges,p,n,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;p=h;for(u in q)if(q.hasOwnProperty(u)&&!isNaN(u)&&(n=q[u],!r(n))){var g=Math.floor((n-A)/b);n<p[g].min&&(p[g].min=n);n>p[g].max&&(p[g].max=n)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=
this._axes[l].dataInfo.dataPointYNegativeSums;p=h;for(u in q)q.hasOwnProperty(u)&&!isNaN(u)&&(n=-1*q[u],r(n)||(g=Math.floor((n-A)/b),n<p[g].min&&(p[g].min=n),n>p[g].max&&(p[g].max=n)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(u=0;u<h.length-1;u++)if(p=h[u].max,isFinite(p))for(;u<h.length-1;)if(A=h[u+1].min,isFinite(A)){n=A-p;n>b&&f.push({diff:n,start:p,end:A});break}else u++;if(this._axes[l].scaleBreaks.customBreaks)for(u=0;u<this._axes[l].scaleBreaks.customBreaks.length;u++)for(b=
...
"area"!==b[c].dataSeries.type&&"stepArea"!==b[c].dataSeries.type||(a?b[c].distance<=a.distance&&(a=b[c]):a=b[c]);return a};m.prototype.getObjectAtXY=function(a,d,c){var b=null;if(c=this.getDataPointAtXY(a,d,c||!1))b=c.dataSeries.dataPointIds[c.dataPointIndex];else if(t)b=Za(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};m.prototype.getAutoFontSize=mb;m.prototype.resetOverlayedCanvas=
function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};m.prototype.clearCanvas=lb;m.prototype.attachEvent=function(a){this._events.push(a)};m.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var d=[],c=a.changedTouches,b=c?c[0]:a,e=null;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];this._lastTouchData=Na(b);this._lastTouchData.time=new Date;break;case "touchmove":case "MSPointerMove":d=["mousemove"];break;
...
new Da(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=0,u=b=l=e=f=0,A=0;for(a=0;a<this._indexLabels.length;a++){var h=this._indexLabels[a],p=h.chartType.toLowerCase(),n,q,u=ka("indexLabelFontColor",h.dataPoint,h.dataSeries),A=ka("indexLabelFontSize",h.dataPoint,h.dataSeries);n=ka("indexLabelFontFamily",h.dataPoint,h.dataSeries);q=ka("indexLabelFontStyle",h.dataPoint,h.dataSeries);var l=ka("indexLabelFontWeight",h.dataPoint,
h.dataSeries),g=ka("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),e=ka("indexLabelMaxWidth",h.dataPoint,h.dataSeries),f=ka("indexLabelWrap",h.dataPoint,h.dataSeries),v=ka("indexLabelLineDashType",h.dataPoint,h.dataSeries),k=ka("indexLabelLineColor",h.dataPoint,h.dataSeries),m=r(h.dataPoint.indexLabelLineThickness)?r(h.dataSeries.options.indexLabelLineThickness)?0:h.dataSeries.options.indexLabelLineThickness:h.dataPoint.indexLabelLineThickness,b=0<m?Math.min(10,("normal"===this.plotInfo.axisPlacement?
...
this.replaceKeywordsWithValue(h.dataPoint.indexLabel,h.dataPoint,h.dataSeries,null,h.indexKeyword):h.dataSeries.indexLabelFormatter?h.dataSeries.indexLabelFormatter(x):h.dataSeries.indexLabel?this.replaceKeywordsWithValue(h.dataSeries.indexLabel,h.dataPoint,h.dataSeries,null,h.indexKeyword):null;if(null!==F&&""!==F){var s=ka("indexLabelPlacement",h.dataPoint,h.dataSeries),x=ka("indexLabelOrientation",h.dataPoint,h.dataSeries),C=h.direction,z=h.dataSeries.axisX,B=h.dataSeries.axisY,w=!1,g=new ia(d,
...
e=l=2;"horizontal"===x?(u=g.width,A=g.height):(A=g.width,u=g.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))s="auto",l=4;else if(0<=p.indexOf("stacked"))"auto"===s&&(s="inside");else if("bubble"===p||"scatter"===p)s="inside";n=h.point.x-("horizontal"===x?u/2:0);"inside"!==s?(e=c.y1,f=c.y2,0<C?(q=h.point.y-A/2-l-b,q<e&&(q="auto"===s?Math.max(h.point.y,e)+A/2+l+b:e+A/2+l+b,w=q+A>h.point.y)):(q=h.point.y+A/2+l+b,q>f-A-l-b&&(q="auto"===s?Math.min(h.point.y,
f)-A/2-l-b:f-A/2-l-b,w=q<h.point.y))):(e=Math.max(h.bounds.y1,c.y1),f=Math.min(h.bounds.y2,c.y2),b=0<=p.indexOf("range")||"error"===p?0<C?Math.max(h.bounds.y1,c.y1)+A/2+l:Math.min(h.bounds.y2,c.y2)-A/2-l:(Math.max(h.bounds.y1,c.y1)+Math.min(h.bounds.y2,c.y2))/2,0<C?(q=Math.max(h.point.y,b),q<e&&("bubble"===p||"scatter"===p)&&(q=Math.max(h.point.y-A-l,c.y1+l))):(q=Math.min(h.point.y,b),q>f-A-l&&("bubble"===p||"scatter"===p)&&(q=Math.min(h.point.y+l,c.y2-A-l))),q=Math.min(q,f))}else 0<=p.indexOf("line")||
0<=p.indexOf("area")||0<=p.indexOf("scatter")?(s="auto",e=4):0<=p.indexOf("stacked")?"auto"===s&&(s="inside"):"bubble"===p&&(s="inside"),q=h.point.y,"inside"!==s?(l=c.x1,f=c.x2,0>C?(n=h.point.x-("horizontal"===x?u:u/2)-e-b,n<l&&(n="auto"===s?Math.max(h.point.x,l)+e+b:l+e+b,w=n+u>h.point.x)):(n=h.point.x+("horizontal"===x?0:u/2)+e+b,n>f-u-e-b&&(n="auto"===s?Math.min(h.point.x,f)-("horizontal"===x?u:u/2)-e-b:f-u-e-b,w=n<h.point.x))):(l=Math.max(h.bounds.x1,c.x1),Math.min(h.bounds.x2,c.x2),b=0<=p.indexOf("range")||
"error"===p?0>C?Math.max(h.bounds.x1,c.x1)+u/2+e:Math.min(h.bounds.x2,c.x2)-u/2-e:(Math.max(h.bounds.x1,c.x1)+Math.min(h.bounds.x2,c.x2))/2,n=0>C?Math.max(h.point.x,b)-("horizontal"===x?u/2:0):Math.min(h.point.x,b)-u/2,n=Math.max(n,l));"vertical"===x&&(q+=A/2);g.x=n;g.y=q;g.render(!0);m&&("inside"!==s&&(0>p.indexOf("bar")&&("error"!==p||!h.axisSwapped)&&h.point.x>c.x1&&h.point.x<c.x2||!w)&&(0>p.indexOf("column")&&("error"!==p||h.axisSwapped)&&h.point.y>c.y1&&h.point.y<c.y2||!w))&&(d.lineWidth=m,d.strokeStyle=
k?k:"gray",d.setLineDash&&d.setLineDash(O(v,m)),d.beginPath(),d.moveTo(h.point.x,h.point.y),0<=p.indexOf("bar")||"error"===p&&h.axisSwapped?d.lineTo(n-(0<h.direction?0:-u)+("vertical"===x?-u/2:0),q+("vertical"===x?-A/2:0)):0<=p.indexOf("column")||"error"===p&&!h.axisSwapped?d.lineTo(n+("horizontal"===x?u/2:0),q+((0<h.direction?A:-A)+("vertical"===x?-A:0))/2):d.lineTo(n+("horizontal"===x?u/2:0),q+((q<h.point.y?A:-A)+("vertical"===x?-A:0))/2),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,
easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)h=this._indexLabels[a],g=ka("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),h.dataSeries.indexLabelBackgroundColor=r(g)?t?"transparent":null:g;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,
e.width,e.height);c.clip();for(var f=[],l,u=0;u<a.dataSeriesIndexes.length;u++){var A=a.dataSeriesIndexes[u],h=this.data[A];c.lineWidth=h.lineThickness;var p=h.dataPoints,n="solid";if(c.setLineDash){var q=O(h.nullDataLineDashType,h.lineThickness),n=h.lineDashType,g=O(n,h.lineThickness);c.setLineDash(g)}var v=h.id;this._eventManager.objectMap[v]={objectType:"dataSeries",dataSeriesIndex:A};v=R(v);b.strokeStyle=v;b.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var v=h._colorSet,k=v=h.lineColor=
h.options.lineColor?h.options.lineColor:v[0];c.strokeStyle=v;var m=!0,s=0,x,r;c.beginPath();if(0<p.length){for(var C=!1,s=0;s<p.length;s++)if(x=p[s].x.getTime?p[s].x.getTime():p[s].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!C)))if("number"!==typeof p[s].y)0<s&&!(h.connectNullData||C||m)&&(c.stroke(),t&&b.stroke()),C=!0;else{x=a.axisX.convertValueToPixel(x);r=a.axisY.convertValueToPixel(p[s].y);var z=h.dataPointIds[s];this._eventManager.objectMap[z]={id:z,
objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:s,x1:x,y1:r};m||C?(!m&&h.connectNullData?(c.setLineDash&&(h.options.nullDataLineDashType||n===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),n=h.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,r),t&&b.lineTo(x,r)):(c.beginPath(),c.moveTo(x,r),t&&(b.beginPath(),b.moveTo(x,r))),C=m=!1):(c.lineTo(x,r),t&&b.lineTo(x,r),0==s%500&&(c.stroke(),c.beginPath(),c.moveTo(x,r),t&&(b.stroke(),b.beginPath(),
b.moveTo(x,r))));l={x:x,y:r};s<p.length-1&&(k!==(p[s].lineColor||v)||n!==(p[s].lineDashType||h.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,r),k=p[s].lineColor||v,c.strokeStyle=k,c.setLineDash&&(p[s].lineDashType?(n=p[s].lineDashType,c.setLineDash(O(n,h.lineThickness))):(n=h.lineDashType,c.setLineDash(g))));if(0<p[s].markerSize||0<h.markerSize){var B=h.getMarkerProperties(s,x,r,c);f.push(B);z=R(z);t&&f.push({x:x,y:r,ctx:b,type:B.type,size:B.size,color:z,borderColor:z,borderThickness:B.borderThickness})}(p[s].indexLabel||
h.indexLabel||p[s].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:p[s],dataSeries:h,point:{x:x,y:r},direction:0>p[s].y===a.axisY.reversed?1:-1,color:v})}c.stroke();t&&b.stroke()}}V.drawMarkers(f);t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=
this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,u=0;u<a.dataSeriesIndexes.length;u++){var A=a.dataSeriesIndexes[u],h=this.data[A];c.lineWidth=h.lineThickness;var p=h.dataPoints,n="solid";if(c.setLineDash){var q=O(h.nullDataLineDashType,h.lineThickness),n=h.lineDashType,g=O(n,h.lineThickness);c.setLineDash(g)}var v=h.id;this._eventManager.objectMap[v]={objectType:"dataSeries",dataSeriesIndex:A};v=R(v);b.strokeStyle=v;b.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,
4):0;var v=h._colorSet,k=v=h.lineColor=h.options.lineColor?h.options.lineColor:v[0];c.strokeStyle=v;var m=!0,s=0,x,r;c.beginPath();if(0<p.length){for(var C=!1,s=0;s<p.length;s++)if(x=p[s].getTime?p[s].x.getTime():p[s].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!C)))if("number"!==typeof p[s].y)0<s&&!(h.connectNullData||C||m)&&(c.stroke(),t&&b.stroke()),C=!0;else{var z=r;x=a.axisX.convertValueToPixel(x);r=a.axisY.convertValueToPixel(p[s].y);var B=h.dataPointIds[s];
this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:s,x1:x,y1:r};m||C?(!m&&h.connectNullData?(c.setLineDash&&(h.options.nullDataLineDashType||n===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),n=h.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,z),c.lineTo(x,r),t&&(b.lineTo(x,z),b.lineTo(x,r))):(c.beginPath(),c.moveTo(x,r),t&&(b.beginPath(),b.moveTo(x,r))),C=m=!1):(c.lineTo(x,z),t&&b.lineTo(x,z),c.lineTo(x,
r),t&&b.lineTo(x,r),0==s%500&&(c.stroke(),c.beginPath(),c.moveTo(x,r),t&&(b.stroke(),b.beginPath(),b.moveTo(x,r))));l={x:x,y:r};s<p.length-1&&(k!==(p[s].lineColor||v)||n!==(p[s].lineDashType||h.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,r),k=p[s].lineColor||v,c.strokeStyle=k,c.setLineDash&&(p[s].lineDashType?(n=p[s].lineDashType,c.setLineDash(O(n,h.lineThickness))):(n=h.lineDashType,c.setLineDash(g))));if(0<p[s].markerSize||0<h.markerSize)z=h.getMarkerProperties(s,x,r,c),f.push(z),B=R(B),
t&&f.push({x:x,y:r,ctx:b,type:z.type,size:z.size,color:B,borderColor:B,borderThickness:z.borderThickness});(p[s].indexLabel||h.indexLabel||p[s].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:p[s],dataSeries:h,point:{x:x,y:r},direction:0>p[s].y===a.axisY.reversed?1:-1,color:v})}c.stroke();t&&b.stroke()}}V.drawMarkers(f);t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&
...
w(a,2);if(0<a.length){b.beginPath();t&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);t&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-3;c+=3)if(b.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+2].y,a[c+3].x,a[c+3].y),t&&e.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+2].y,a[c+3].x,a[c+3].y),0<c&&0===c%3E3||a[c+3].newStrokeStyle||a[c+3].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(a[c+3].x,
...
a.dataSeriesIndexes[u],h=this.data[A];b.lineWidth=h.lineThickness;var p=h.dataPoints,n="solid";if(b.setLineDash){var q=O(h.nullDataLineDashType,h.lineThickness),n=h.lineDashType,g=O(n,h.lineThickness);b.setLineDash(g)}var v=h.id;this._eventManager.objectMap[v]={objectType:"dataSeries",dataSeriesIndex:A};v=R(v);e.strokeStyle=v;e.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var v=h._colorSet,k=v=h.lineColor=h.options.lineColor?h.options.lineColor:v[0];b.strokeStyle=v;var m=0,s,x,r=[];b.beginPath();
...
{id:C,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:m,x1:s,y1:x};r[r.length]={x:s,y:x};m<p.length-1&&(k!==(p[m].lineColor||v)||n!==(p[m].lineDashType||h.lineDashType))&&(k=p[m].lineColor||v,r[r.length-1].newStrokeStyle=k,b.setLineDash&&(p[m].lineDashType?(n=p[m].lineDashType,r[r.length-1].newLineDashArray=O(n,h.lineThickness)):(n=h.lineDashType,r[r.length-1].newLineDashArray=g)));if(0<p[m].markerSize||0<h.markerSize){var z=h.getMarkerProperties(m,s,x,b);l.push(z);C=R(C);t&&l.push({x:s,y:x,
ctx:e,type:z.type,size:z.size,color:C,borderColor:C,borderThickness:z.borderThickness})}(p[m].indexLabel||h.indexLabel||p[m].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:p[m],dataSeries:h,point:{x:s,y:x},direction:0>p[m].y===a.axisY.reversed?1:-1,color:v});x=!1}d(r)}V.drawMarkers(l);t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,
this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(f.x1,f.y1,f.width,f.height),e.beginPath());b.restore();b.beginPath();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:
...
n=this.dataPointWidth=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(n)/Math.log(a.axisX.range):Math.abs(n)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>p&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&p<f)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));n<f&&(n=f);n>p&&(n=p);c.save();t&&this._eventManager.ghostCtx.save();
...
a.axisX.convertValueToPixel(A);u=a.axisY.convertValueToPixel(v[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+p)*n<<0:l-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var m=a.axisX.reversed?l-n<<0:l+n<<0,s;0<=v[f].y?s=h:(s=u,u=h);u>s&&(b=u,u=s,s=b);b=v[f].color?v[f].color:g._colorSet[f%g._colorSet.length];ba(c,l,u,m,s,b,0,null,k&&0<=v[f].y,0>v[f].y&&k,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",
dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:u,x2:m,y2:s};b=R(b);t&&ba(this._eventManager.ghostCtx,l,u,m,s,b,0,null,!1,!1,!1,!1);(v[f].indexLabel||g.indexLabel||v[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:v[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>v[f].y===a.axisY.reversed?u:s},direction:0>v[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(u,s),x2:m,y2:Math.max(u,s)},color:b})}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
p<h)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>p&&(g=p);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var k=a.dataSeriesIndexes[v],m=this.data[k],s=m.dataPoints;if(0<s.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle=
"#4572A7 ";for(h=0;h<s.length;h++)if(b=s[h].x.getTime?s[h].x.getTime():s[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[h].y){p=a.axisX.convertValueToPixel(b);var r=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=r+g<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<s[h].y)u[b]=s[h].y+(u[b]?u[b]:0),0<u[b]&&(n=a.axisY.convertValueToPixel(u[b]),z="undefined"!==typeof f[b]?f[b]:q,f[b]=n);else if(a.axisY.scaleBreaks&&
0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[h].y)A[b]=s[h].y+(A[b]?A[b]:0),z=a.axisY.convertValueToPixel(A[b]),n="undefined"!==typeof l[b]?l[b]:q,l[b]=z;else if(n=a.axisY.convertValueToPixel(s[h].y),0<=s[h].y){var B="undefined"!==typeof f[b]?f[b]:0;n-=B;z=q-B;f[b]=B+(z-n)}else B=l[b]?l[b]:0,z=n+B,n=q+B,l[b]=B+(z-n);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];ba(c,r,n,C,z,b,0,null,x&&0<=s[h].y,0>s[h].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]=
{id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:r,y1:n,x2:C,y2:z};b=R(b);t&&ba(this._eventManager.ghostCtx,r,n,C,z,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:s[h],dataSeries:m,point:{x:p,y:0<=s[h].y?n:z},direction:0>s[h].y===a.axisY.reversed?1:-1,bounds:{x1:r,y1:Math.min(n,z),x2:C,y2:Math.max(n,z)},color:b})}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,
this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,
animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],u=[],A=[],h=0,p,n,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;p=this.options.dataPointMaxWidth?
this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>p&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&
p<h)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>p&&(g=p);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var k=a.dataSeriesIndexes[v],m=this.data[k],s=m.dataPoints;if(0<s.length)for(var x=5<g&&m.bevelEnabled?!0:!1,
h=0;h<s.length;h++)if(b=s[h].x.getTime?s[h].x.getTime():s[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[h].y){p=a.axisX.convertValueToPixel(b);n=0!==a.dataPointYSums[b]?100*(s[h].y/a.dataPointYSums[b]):0;var r=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=r+g<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<s[h].y){u[b]=n+("undefined"!==typeof u[b]?u[b]:0);if(0>=u[b])continue;n=a.axisY.convertValueToPixel(u[b]);
...
B+(z-n);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];ba(c,r,n,C,z,b,0,null,x&&0<=s[h].y,0>s[h].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:r,y1:n,x2:C,y2:z};b=R(b);t&&ba(this._eventManager.ghostCtx,r,n,C,z,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:s[h],dataSeries:m,
point:{x:p,y:0<=s[h].y?n:z},direction:0>s[h].y===a.axisY.reversed?1:-1,bounds:{x1:r,y1:Math.min(n,z),x2:C,y2:Math.max(n,z)},color:b})}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,u,A,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
Math.abs(n)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>p&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&p<f)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));n<f&&(n=f);n>p&&(n=p);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],v=g.dataPoints;if(0<v.length){var k=5<n&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<v.length;f++)if(v[f].getTime?A=v[f].x.getTime():A=v[f].x,!(A<a.axisX.dataInfo.viewPortMin||A>a.axisX.dataInfo.viewPortMax)&&"number"===typeof v[f].y){u=a.axisX.convertValueToPixel(A);l=a.axisY.convertValueToPixel(v[f].y);u=a.axisX.reversed?u+a.plotType.totalDataSeries*
n/2-(a.previousDataSeriesCount+p)*n<<0:u-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var m=a.axisX.reversed?u-n<<0:u+n<<0,s;0<=v[f].y?s=h:(s=l,l=h);b=v[f].color?v[f].color:g._colorSet[f%g._colorSet.length];ba(c,s,u,l,m,b,0,null,k,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:s,y1:u,x2:l,y2:m};b=R(b);t&&ba(this._eventManager.ghostCtx,s,u,l,m,b,0,null,!1,!1,!1,!1);(v[f].indexLabel||
...
this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>n&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<h)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>n&&(g=n);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();
c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var k=a.dataSeriesIndexes[v],m=this.data[k],s=m.dataPoints;if(0<s.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<s.length;h++)if(b=s[h].x.getTime?s[h].x.getTime():s[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===
typeof s[h].y){n=a.axisX.convertValueToPixel(b);var r=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=r+g<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<s[h].y)u[b]=s[h].y+(u[b]?u[b]:0),0<u[b]&&(z=f[b]?f[b]:q,f[b]=p=a.axisY.convertValueToPixel(u[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[h].y)A[b]=s[h].y+(A[b]?A[b]:0),p=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(A[b]);else if(p=a.axisY.convertValueToPixel(s[h].y),
0<=s[h].y){var B=f[b]?f[b]:0;z=q+B;p+=B;f[b]=B+(p-z)}else B=l[b]?l[b]:0,z=p-B,p=q-B,l[b]=B+(p-z);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];ba(c,z,r,p,C,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:z,y1:r,x2:p,y2:C};b=R(b);t&&ba(this._eventManager.ghostCtx,z,r,p,C,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",
dataPoint:s[h],dataSeries:m,point:{x:0<=s[h].y?p:z,y:n},direction:0>s[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,p),y1:r,x2:Math.max(z,p),y2:C},color:b})}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.xScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,
...
Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>n&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<h)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>n&&(g=n);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,
...
n-a.plotType.plotUnits.length*g/2+a.index*g<<0,z=C+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<s[h].y){u[b]=r+(u[b]?u[b]:0);if(0>=u[b])continue;r=f[b]?f[b]:q;f[b]=p=a.axisY.convertValueToPixel(u[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[h].y)A[b]=r+(A[b]?A[b]:0),p=l[b]?l[b]:q,l[b]=r=a.axisY.convertValueToPixel(A[b]);else if(p=a.axisY.convertValueToPixel(r),0<=s[h].y){var B=f[b]?f[b]:0;r=q+B;p+=B;a.dataSeriesIndexes.length-
1===v&&1>=Math.abs(e.x2-p)&&(p=e.x2);f[b]=B+(p-r)}else B=l[b]?l[b]:0,r=p-B,p=q-B,a.dataSeriesIndexes.length-1===v&&1>=Math.abs(e.x1-r)&&(r=e.x1),l[b]=B+(p-r);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];ba(c,r,C,p,z,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:r,y1:C,x2:p,y2:z};b=R(b);t&&ba(this._eventManager.ghostCtx,r,C,p,z,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||
s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:s[h],dataSeries:m,point:{x:0<=s[h].y?p:r,y:n},direction:0>s[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(r,p),y1:C,x2:Math.max(r,p),y2:z},color:b})}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
...
f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=F:0>a.axisY.viewportMaximum?C=u.y1:0<a.axisY.viewportMinimum&&(C=F),f.lineTo(m,C),f.lineTo(z.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,t&&(l.lineTo(m,C),l.lineTo(z.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,s),l.beginPath(),l.moveTo(m,s),z={x:m,y:s})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=t?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,
u=a.axisY.lineCoordinates,A=[],h=this.plotArea,p;f.save();t&&l.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();t&&(l.beginPath(),l.rect(h.x1,h.y1,h.width,h.height),l.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],v=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=R(A);l.fillStyle=A;A=[];d=!0;var k=0,m,s,r,F=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
C,z=null;if(0<v.length){var B=g._colorSet[k%g._colorSet.length],w=g.lineColor=g.options.lineColor||B,y=w;f.fillStyle=B;f.strokeStyle=w;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var K=O(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var aa=O(c,g.lineThickness);f.setLineDash(aa)}for(var ja=!0;k<v.length;k++)if(r=v[k].x.getTime?v[k].x.getTime():v[k].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ja)))if("number"!==typeof v[k].y)g.connectNullData||
(ja||d)||b(),ja=!0;else{m=a.axisX.convertValueToPixel(r);s=a.axisY.convertValueToPixel(v[k].y);d||ja?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=s,m=p.x,s=p.y,b(),f.moveTo(p.x,p.y),m=d,s=c,z=p,c=g.nullDataLineDashType,f.setLineDash(K)),f.lineTo(m,s),t&&l.lineTo(m,s)):(f.beginPath(),f.moveTo(m,s),t&&(l.beginPath(),l.moveTo(m,s)),z={x:m,y:s}),ja=d=!1):(f.lineTo(m,s),t&&l.lineTo(m,s),0==k%250&&b());p={x:m,
y:s};k<v.length-1&&(y!==(v[k].lineColor||w)||c!==(v[k].lineDashType||g.lineDashType))&&(b(),y=v[k].lineColor||w,f.strokeStyle=y,f.setLineDash&&(v[k].lineDashType?(c=v[k].lineDashType,f.setLineDash(O(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(aa))));var Y=g.dataPointIds[k];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,x1:m,y1:s};0!==v[k].markerSize&&(0<v[k].markerSize||0<g.markerSize)&&(r=g.getMarkerProperties(k,m,s,f),A.push(r),Y=R(Y),t&&
A.push({x:m,y:s,ctx:l,type:r.type,size:r.size,color:Y,borderColor:Y,borderThickness:r.borderThickness}));(v[k].indexLabel||g.indexLabel||v[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:v[k],dataSeries:g,point:{x:m,y:s},direction:0>v[k].y===a.axisY.reversed?1:-1,color:B})}b();V.drawMarkers(A)}}t&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,
...
1].x,m);b.lineTo(s.x,m);b.closePath();b.globalAlpha=p.fillOpacity;b.fill();b.globalAlpha=1;t&&(e.lineTo(c[c.length-1].x,m),e.lineTo(s.x,m),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],u=this.plotArea;b.save();t&&e.save();b.beginPath();b.rect(u.x1,u.y1,u.width,u.height);b.clip();t&&(e.beginPath(),e.rect(u.x1,u.y1,u.width,u.height),e.clip());for(var A=
0;A<a.dataSeriesIndexes.length;A++){var h=a.dataSeriesIndexes[A],p=this.data[h],n=p.dataPoints,l=p.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:h};l=R(l);e.fillStyle=l;var l=[],q=0,g,v,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,s=null,r=[];if(0<n.length){var F=p._colorSet[q%p._colorSet.length],C=p.lineColor=p.options.lineColor||F,z=C;b.fillStyle=F;b.strokeStyle=C;b.lineWidth=p.lineThickness;var B="solid";if(b.setLineDash){var y=O(p.nullDataLineDashType,
p.lineThickness),B=p.lineDashType,D=O(B,p.lineThickness);b.setLineDash(D)}for(v=!1;q<n.length;q++)if(g=n[q].x.getTime?n[q].x.getTime():n[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!p.connectNullData||!v)))if("number"!==typeof n[q].y)0<q&&!v&&(p.connectNullData?b.setLineDash&&(0<r.length&&(p.options.nullDataLineDashType||!n[q-1].lineDashType))&&(r[r.length-1].newLineDashArray=y,B=p.nullDataLineDashType):(d(),r=[])),v=!0;else{g=a.axisX.convertValueToPixel(g);v=a.axisY.convertValueToPixel(n[q].y);
var K=p.dataPointIds[q];this._eventManager.objectMap[K]={id:K,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:q,x1:g,y1:v};r[r.length]={x:g,y:v};q<n.length-1&&(z!==(n[q].lineColor||C)||B!==(n[q].lineDashType||p.lineDashType))&&(z=n[q].lineColor||C,r[r.length-1].newStrokeStyle=z,b.setLineDash&&(n[q].lineDashType?(B=n[q].lineDashType,r[r.length-1].newLineDashArray=O(B,p.lineThickness)):(B=p.lineDashType,r[r.length-1].newLineDashArray=D)));if(0!==n[q].markerSize&&(0<n[q].markerSize||0<p.markerSize)){var aa=
p.getMarkerProperties(q,g,v,b);l.push(aa);K=R(K);t&&l.push({x:g,y:v,ctx:e,type:aa.type,size:aa.size,color:K,borderColor:K,borderThickness:aa.borderThickness})}(n[q].indexLabel||p.indexLabel||n[q].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:n[q],dataSeries:p,point:{x:g,y:v},direction:0>n[q].y===a.axisY.reversed?1:-1,color:F});v=!1}d();V.drawMarkers(l)}}t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
...
function(a){var d,c;function b(){z&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=F:0>a.axisY.viewportMaximum?C=u.y1:0<a.axisY.viewportMinimum&&(C=F),f.lineTo(m,C),f.lineTo(z.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,t&&(l.lineTo(m,C),l.lineTo(z.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,s),l.beginPath(),l.moveTo(m,s),z={x:m,y:s})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=t?this._preRenderCtx:
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,u=a.axisY.lineCoordinates,A=[],h=this.plotArea,p;f.save();t&&l.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();t&&(l.beginPath(),l.rect(h.x1,h.y1,h.width,h.height),l.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],v=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=R(A);l.fillStyle=A;A=[];d=!0;var k=0,m,s,r,F=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),C,z=null;c=!1;if(0<v.length){var B=g._colorSet[k%g._colorSet.length],w=g.lineColor=g.options.lineColor||B,y=w;f.fillStyle=B;f.strokeStyle=w;f.lineWidth=g.lineThickness;var K="solid";if(f.setLineDash){var aa=O(g.nullDataLineDashType,g.lineThickness),K=g.lineDashType,D=O(K,g.lineThickness);f.setLineDash(D)}for(;k<v.length;k++)if(r=v[k].x.getTime?v[k].x.getTime():v[k].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Y=s;"number"!==
typeof v[k].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(r),s=a.axisY.convertValueToPixel(v[k].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||K===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=s,m=p.x,s=p.y,b(),f.moveTo(p.x,p.y),m=d,s=c,z=p,K=g.nullDataLineDashType,f.setLineDash(aa)),f.lineTo(m,Y),f.lineTo(m,s),t&&(l.lineTo(m,Y),l.lineTo(m,s))):(f.beginPath(),f.moveTo(m,s),t&&(l.beginPath(),l.moveTo(m,s)),z={x:m,y:s}),c=
d=!1):(f.lineTo(m,Y),t&&l.lineTo(m,Y),f.lineTo(m,s),t&&l.lineTo(m,s),0==k%250&&b()),p={x:m,y:s},k<v.length-1&&(y!==(v[k].lineColor||w)||K!==(v[k].lineDashType||g.lineDashType))&&(b(),y=v[k].lineColor||w,f.strokeStyle=y,f.setLineDash&&(v[k].lineDashType?(K=v[k].lineDashType,f.setLineDash(O(K,g.lineThickness))):(K=g.lineDashType,f.setLineDash(D)))),r=g.dataPointIds[k],this._eventManager.objectMap[r]={id:r,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,x1:m,y1:s},0!==v[k].markerSize&&(0<v[k].markerSize||
0<g.markerSize)&&(Y=g.getMarkerProperties(k,m,s,f),A.push(Y),r=R(r),t&&A.push({x:m,y:s,ctx:l,type:Y.type,size:Y.size,color:r,borderColor:r,borderThickness:Y.borderThickness})),(v[k].indexLabel||g.indexLabel||v[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:v[k],dataSeries:g,point:{x:m,y:s},direction:0>v[k].y===a.axisY.reversed?1:-1,color:B}))}b();V.drawMarkers(A)}}t&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(h.x1,h.y1,h.width,h.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=
function(a){function d(){if(!(1>h.length)){for(0<B.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);t&&r.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();t&&(r.closePath(),r.fill(),r.beginPath());h=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],u=this.plotArea,A=[],h=[],p=[],n=[],q=0,g,k,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:
0),r=this._eventManager.ghostCtx,s,x,F;t&&r.beginPath();b.save();t&&r.save();b.beginPath();b.rect(u.x1,u.y1,u.width,u.height);b.clip();t&&(r.beginPath(),r.rect(u.x1,u.y1,u.width,u.height),r.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var z=a.dataSeriesIndexes[C],B=this.data[z],w=B.dataPoints;B.dataPointIndexes=[];for(q=0;q<w.length;q++)z=w[q].x.getTime?w[q].x.getTime():w[q].x,B.dataPointIndexes[z]=q,e[z]||(p.push(z),e[z]=!0);p.sort(Qa)}for(C=0;C<a.dataSeriesIndexes.length;C++){z=a.dataSeriesIndexes[C];
B=this.data[z];w=B.dataPoints;x=!0;h=[];q=B.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:z};q=R(q);r.fillStyle=q;if(0<p.length){var e=B._colorSet[0],y=B.lineColor=B.options.lineColor||e,K=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=B.lineThickness;F="solid";if(b.setLineDash){var aa=O(B.nullDataLineDashType,B.lineThickness);F=B.lineDashType;var D=O(F,B.lineThickness);b.setLineDash(D)}for(var Y=!0,q=0;q<p.length;q++){var f=p[q],ea=null,ea=0<=B.dataPointIndexes[f]?w[B.dataPointIndexes[f]]:
{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Y)))if("number"!==typeof ea.y)B.connectNullData||(Y||x)||d(),Y=!0;else{g=a.axisX.convertValueToPixel(f);var la=A[f]?A[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){n[f]=ea.y+(n[f]?n[f]:0);if(0>=n[f]&&a.axisY.logarithmic)continue;k=a.axisY.convertValueToPixel(n[f])}else k=a.axisY.convertValueToPixel(ea.y),k-=la;h.push({x:g,y:m-la});A[f]=m-k;x||Y?(!x&&
B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||F===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(x=h.pop(),F=h[h.length-1],d(),b.moveTo(s.x,s.y),h.push(F),h.push(x),F=B.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,k),t&&r.lineTo(g,k)):(b.beginPath(),b.moveTo(g,k),t&&(r.beginPath(),r.moveTo(g,k))),Y=x=!1):(b.lineTo(g,k),t&&r.lineTo(g,k),0==q%250&&(d(),b.moveTo(g,k),t&&r.moveTo(g,k),h.push({x:g,y:m-la})));s={x:g,y:k};q<w.length-1&&(K!==(w[q].lineColor||y)||F!==
(w[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,k),h.push({x:g,y:m-la}),K=w[q].lineColor||y,b.strokeStyle=K,b.setLineDash&&(w[q].lineDashType?(F=w[q].lineDashType,b.setLineDash(O(F,B.lineThickness))):(F=B.lineDashType,b.setLineDash(D))));if(0<=B.dataPointIndexes[f]){var E=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:k}}0<=B.dataPointIndexes[f]&&0!==ea.markerSize&&
(0<ea.markerSize||0<B.markerSize)&&(la=B.getMarkerProperties(B.dataPointIndexes[f],g,k,b),l.push(la),f=R(E),t&&l.push({x:g,y:k,ctx:r,type:la.type,size:la.size,color:f,borderColor:f,borderThickness:la.borderThickness}));(ea.indexLabel||B.indexLabel||ea.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ea,dataSeries:B,point:{x:g,y:k},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,k);t&&r.moveTo(g,k)}delete B.dataPointIndexes}V.drawMarkers(l);
t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(u.x1,u.y1,u.width,u.height),r.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,
easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<B.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);t&&F.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();t&&(F.closePath(),F.fill(),F.beginPath());h=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,u=[],k=[],h=[],p=[],n=[],q=
0,g,v,m,r,s,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),F=this._eventManager.ghostCtx;b.save();t&&F.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();t&&(F.beginPath(),F.rect(l.x1,l.y1,l.width,l.height),F.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var z=a.dataSeriesIndexes[C],B=this.data[z],w=B.dataPoints;B.dataPointIndexes=[];for(q=0;q<w.length;q++)z=w[q].x.getTime?w[q].x.getTime():w[q].x,B.dataPointIndexes[z]=q,e[z]||(p.push(z),e[z]=
!0);p.sort(Qa)}for(C=0;C<a.dataSeriesIndexes.length;C++){z=a.dataSeriesIndexes[C];B=this.data[z];w=B.dataPoints;r=!0;e=B.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:z};e=R(e);F.fillStyle=e;h=[];if(0<p.length){var e=B._colorSet[q%B._colorSet.length],y=B.lineColor=B.options.lineColor||e,K=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=B.lineThickness;s="solid";if(b.setLineDash){var aa=O(B.nullDataLineDashType,B.lineThickness);s=B.lineDashType;var D=O(s,B.lineThickness);
b.setLineDash(D)}for(var Y=!0,q=0;q<p.length;q++){var f=p[q],ea=null,ea=0<=B.dataPointIndexes[f]?w[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Y)))if("number"!==typeof ea.y)B.connectNullData||(Y||r)||d(),Y=!0;else{var la;la=0!==a.dataPointYSums[f]?100*(ea.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var E=k[f]?k[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){n[f]=
la+(n[f]?n[f]:0);if(0>=n[f]&&a.axisY.logarithmic)continue;v=a.axisY.convertValueToPixel(n[f])}else v=a.axisY.convertValueToPixel(la),v-=E;h.push({x:g,y:x-E});k[f]=x-v;r||Y?(!r&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||s===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(r=h.pop(),s=h[h.length-1],d(),b.moveTo(m.x,m.y),h.push(s),h.push(r),s=B.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,v),t&&F.lineTo(g,v)):(b.beginPath(),b.moveTo(g,v),t&&(F.beginPath(),F.moveTo(g,
v))),Y=r=!1):(b.lineTo(g,v),t&&F.lineTo(g,v),0==q%250&&(d(),b.moveTo(g,v),t&&F.moveTo(g,v),h.push({x:g,y:x-E})));m={x:g,y:v};q<w.length-1&&(K!==(w[q].lineColor||y)||s!==(w[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,v),h.push({x:g,y:x-E}),K=w[q].lineColor||y,b.strokeStyle=K,b.setLineDash&&(w[q].lineDashType?(s=w[q].lineDashType,b.setLineDash(O(s,B.lineThickness))):(s=B.lineDashType,b.setLineDash(D))));if(0<=B.dataPointIndexes[f]){var G=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[G]=
{id:G,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:v}}0<=B.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<B.markerSize)&&(E=B.getMarkerProperties(q,g,v,b),u.push(E),f=R(G),t&&u.push({x:g,y:v,ctx:F,type:E.type,size:E.size,color:f,borderColor:f,borderThickness:E.borderThickness}));(ea.indexLabel||B.indexLabel||ea.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ea,dataSeries:B,point:{x:g,y:v},
direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,v);t&&F.moveTo(g,v)}delete B.dataPointIndexes}V.drawMarkers(u);t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
b.clearRect(l.x1,l.y1,l.width,l.height),F.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),
...
v),h=0;h<a.dataSeriesIndexes.length;h++)if(p=a.dataSeriesIndexes[h],n=this.data[p],q=n.dataPoints,0<q.length)for(c.strokeStyle="#4572A7 ",e=0;e<q.length;e++)if(f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);var g=q[e].z,r=2*Math.max(Math.sqrt((u===k?m/2:v+(m-v)/(u-k)*(g-k))/Math.PI)<<0,1),g=n.getMarkerProperties(e,c);g.size=r;c.globalAlpha=
n.fillOpacity;V.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var s=n.dataPointIds[e];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:e,x1:f,y1:l,size:r};r=R(s);t&&V.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,r,r,g.borderThickness);(q[e].indexLabel||n.indexLabel||q[e].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:n,point:{x:f,y:l},
direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null})}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,
b.width,b.height),this._eventManager.ghostCtx.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var k=a.dataSeriesIndexes[u],h=this.data[k],p=h.dataPoints;if(0<p.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,b.width)/2,2);for(var n=0,q=0,e=0;e<p.length;e++)if(f=p[e].getTime?f=p[e].x.getTime():f=p[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof p[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(p[e].y);var g=h.getMarkerProperties(e,
f,l,c);c.globalAlpha=h.fillOpacity;V.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((n-f)*(n-f)+(q-l)*(q-l))<Math.min(g.size,5)&&p.length>Math.min(this.plotArea.width,this.plotArea.height)||(n=h.dataPointIds[e],this._eventManager.objectMap[n]={id:n,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:e,x1:f,y1:l},n=R(n),t&&V.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,n,n,g.borderThickness),(p[e].indexLabel||h.indexLabel||
p[e].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:p[e],dataSeries:h,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),n=f,q=l)}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderCandlestick=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=
...
if(0<x.length)for(var F=5<v&&s.bevelEnabled?!0:!1,u=0;u<x.length;u++)if(x[u].getTime?g=x[u].x.getTime():g=x[u].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(x[u].y)&&x[u].y.length&&"number"===typeof x[u].y[0]&&"number"===typeof x[u].y[1]&&"number"===typeof x[u].y[2]&&"number"===typeof x[u].y[3]){k=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(x[u].y[0]);p=a.axisY.convertValueToPixel(x[u].y[1]);n=a.axisY.convertValueToPixel(x[u].y[2]);q=a.axisY.convertValueToPixel(x[u].y[3]);
var w=k-v/2<<0,z=w+v<<0,f=s.options.fallingColor?s.fallingColor:s._colorSet[0],e=x[u].color?x[u].color:s._colorSet[0],B=Math.round(Math.max(1,0.15*v)),y=0===B%2?0:0.5,D=s.dataPointIds[u];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:fa,dataPointIndex:u,x1:w,y1:h,x2:z,y2:p,x3:k,y3:n,x4:k,y4:q,borderThickness:B,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=B;b.lineWidth=Math.max(B,4);"candlestick"===s.type?(c.moveTo(k-y,p),c.lineTo(k-y,Math.min(h,q)),c.stroke(),c.moveTo(k-
y,Math.max(h,q)),c.lineTo(k-y,n),c.stroke(),ba(c,w,Math.min(h,q),z,Math.max(h,q),x[u].y[0]<=x[u].y[3]?s.risingColor:f,B,e,F,F,!1,!1,s.fillOpacity),t&&(e=R(D),b.strokeStyle=e,b.moveTo(k-y,p),b.lineTo(k-y,Math.min(h,q)),b.stroke(),b.moveTo(k-y,Math.max(h,q)),b.lineTo(k-y,n),b.stroke(),ba(b,w,Math.min(h,q),z,Math.max(h,q),e,0,null,!1,!1,!1,!1))):"ohlc"===s.type&&(c.moveTo(k-y,p),c.lineTo(k-y,n),c.stroke(),c.beginPath(),c.moveTo(k,h),c.lineTo(w,h),c.stroke(),c.beginPath(),c.moveTo(k,q),c.lineTo(z,q),
c.stroke(),t&&(e=R(D),b.strokeStyle=e,b.moveTo(k-y,p),b.lineTo(k-y,n),b.stroke(),b.beginPath(),b.moveTo(k,h),b.lineTo(w,h),b.stroke(),b.beginPath(),b.moveTo(k,q),b.lineTo(z,q),b.stroke()));(x[u].indexLabel||s.indexLabel||x[u].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:s.type,dataPoint:x[u],dataSeries:s,point:{x:w+(z-w)/2,y:a.axisY.reversed?n:p},direction:1,bounds:{x1:w,y1:Math.min(p,n),x2:z,y2:Math.max(p,n)},color:e})}}t&&(d.drawImage(this._preRenderCanvas,0,0,
...
animationBase:0}}};m.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,l=0,u,k,h,p,n,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.015*this.width,v=a.axisX.dataInfo.minDiff;isFinite(v)||
(v=0.3*Math.abs(a.axisX.range));v=this.options.dataPointWidth?this.dataPointWidth:0.7*f.width*(a.axisX.logarithmic?Math.log(v)/Math.log(a.axisX.range):Math.abs(v)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));v<e&&(v=e);v>l&&(v=l);c.save();t&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,
f.height);c.clip();t&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,w=0;w<a.dataSeriesIndexes.length;w++){var s=a.dataSeriesIndexes[w],x=this.data[s],F=x.dataPoints;if(0<F.length)for(var C=5<v&&x.bevelEnabled?!0:!1,l=0;l<F.length;l++)if(F[l].getTime?g=F[l].x.getTime():g=F[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(F[l].y)&&F[l].y.length&&"number"===typeof F[l].y[0]&&"number"===typeof F[l].y[1]&&"number"===typeof F[l].y[2]&&
"number"===typeof F[l].y[3]&&"number"===typeof F[l].y[4]&&5===F[l].y.length){u=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(F[l].y[0]);h=a.axisY.convertValueToPixel(F[l].y[1]);p=a.axisY.convertValueToPixel(F[l].y[2]);n=a.axisY.convertValueToPixel(F[l].y[3]);q=a.axisY.convertValueToPixel(F[l].y[4]);var z=u-v/2<<0,B=u+v/2<<0,e=F[l].color?F[l].color:x._colorSet[0],y=Math.round(Math.max(1,0.15*v)),D=0===y%2?0:0.5,K=F[l].whiskerColor?F[l].whiskerColor:F[l].color?x.whiskerColor?x.whiskerColor:
F[l].color:x.whiskerColor?x.whiskerColor:e,aa="number"===typeof F[l].whiskerThickness?F[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,E=F[l].whiskerDashType?F[l].whiskerDashType:x.whiskerDashType,Y=r(F[l].whiskerLength)?r(x.options.whiskerLength)?v:x.whiskerLength:F[l].whiskerLength,Y="number"===typeof Y?0>=Y?0:Y>=v?v:Y:"string"===typeof Y?parseInt(Y)*v/100>v?v:parseInt(Y)*v/100:v,ea=1===Math.round(aa)%2?0.5:0,la=F[l].stemColor?F[l].stemColor:F[l].color?x.stemColor?
x.stemColor:F[l].color:x.stemColor?x.stemColor:e,Aa="number"===typeof F[l].stemThickness?F[l].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:y,G=1===Math.round(Aa)%2?0.5:0,J=F[l].stemDashType?F[l].stemDashType:x.stemDashType,H=F[l].lineColor?F[l].lineColor:F[l].color?x.lineColor?x.lineColor:F[l].color:x.lineColor?x.lineColor:e,N="number"===typeof F[l].lineThickness?F[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,S=F[l].lineDashType?F[l].lineDashType:
x.lineDashType,M=1===Math.round(N)%2?0.5:0,Q=x.upperBoxColor,wa=x.lowerBoxColor,ra=r(x.options.fillOpacity)?1:x.fillOpacity,P=x.dataPointIds[l];this._eventManager.objectMap[P]={id:P,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:l,x1:z,y1:k,x2:B,y2:h,x3:u,y3:p,x4:u,y4:n,y5:q,borderThickness:y,color:e,stemThickness:Aa,stemColor:la,whiskerThickness:aa,whiskerLength:Y,whiskerColor:K,lineThickness:N,lineColor:H};c.save();0<Aa&&(c.beginPath(),c.strokeStyle=la,c.lineWidth=Aa,c.setLineDash&&c.setLineDash(O(J,
Aa)),c.moveTo(u-G,h),c.lineTo(u-G,k),c.stroke(),c.moveTo(u-G,n),c.lineTo(u-G,p),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();ba(c,z,Math.min(q,h),B,Math.max(h,q),wa,0,e,m?C:!1,m?!1:C,!1,!1,ra);c.beginPath();ba(c,z,Math.min(p,q),B,Math.max(q,p),Q,0,e,m?!1:C,m?C:!1,!1,!1,ra);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(z-D,Math.min(h,p)-D,B-z+2*D,Math.max(h,p)-Math.min(h,p)+2*D);c.stroke();c.save();0<N&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(O(S,N)),c.strokeStyle=
H,c.lineWidth=N,c.moveTo(z,q-M),c.lineTo(B,q-M),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(O(E,aa)),c.strokeStyle=K,c.lineWidth=aa,c.moveTo(u-Y/2<<0,n-ea),c.lineTo(u+Y/2<<0,n-ea),c.stroke(),c.moveTo(u-Y/2<<0,k+ea),c.lineTo(u+Y/2<<0,k+ea),c.stroke());c.restore();t&&(e=R(P),b.strokeStyle=e,b.lineWidth=Aa,0<Aa&&(b.moveTo(u-D-G,h),b.lineTo(u-D-G,Math.max(k,n)),b.stroke(),b.moveTo(u-D-G,Math.min(k,n)),b.lineTo(u-D-G,p),b.stroke()),ba(b,z,Math.max(h,p),B,Math.min(h,
p),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(u+Y/2,n-ea),b.lineTo(u-Y/2,n-ea),b.stroke(),b.moveTo(u+Y/2,k+ea),b.lineTo(u-Y/2,k+ea),b.stroke()));(F[l].indexLabel||x.indexLabel||F[l].indexLabelFormatter||x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:F[l],dataSeries:x,point:{x:z+(B-z)/2,y:a.axisY.reversed?k:n},direction:1,bounds:{x1:z,y1:Math.min(k,n),x2:B,y2:Math.max(k,n)},color:e})}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),b.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeColumn=
...
0.9*(e.width*(a.axisX.logarithmic?Math.log(h)/Math.log(a.axisX.range):Math.abs(h)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>l&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));h<f&&(h=f);h>l&&(h=l);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),
...
a.axisY.convertValueToPixel(g[f].y[0]);u=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*h/2-(a.previousDataSeriesCount+p)*h<<0:b-a.plotType.totalDataSeries*h/2+(a.previousDataSeriesCount+p)*h<<0,w=a.axisX.reversed?m-h<<0:m+h<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>u){var s=l;l=u;u=s}s=q.dataPointIds[f];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,x1:m,y1:l,x2:w,y2:u};ba(c,m,l,w,
u,b,0,b,v,v,!1,!1,q.fillOpacity);b=R(s);t&&ba(this._eventManager.ghostCtx,m,l,w,u,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?u:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,u),x2:w,y2:Math.max(l,u)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,
point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?l:u},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,u),x2:w,y2:Math.max(l,u)},color:b})}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,
this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderError=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d,b=a.axisY._position?"left"===a.axisY._position||"right"===a.axisY._position?!1:!0:!1;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=!1,l=this.plotArea,u=0,k,h,p,
n,q,g,m,Pa=a.axisX.dataInfo.minDiff;isFinite(Pa)||(Pa=0.3*Math.abs(a.axisX.range));c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var w=0,s=0;s<this.data.length;s++)!this.data[s].type.match(/(bar|column)/ig)||!this.data[s].visible||this.data[s].type.match(/(stacked)/ig)&&w||w++;for(var x=0;x<a.dataSeriesIndexes.length;x++){var F=
a.dataSeriesIndexes[x],C=this.data[F],z=C.dataPoints,B=r(C._linkedSeries)?!1:C._linkedSeries.type.match(/(bar|column)/ig)&&C._linkedSeries.visible?!0:!1,D=0;if(B)for(e=C._linkedSeries.id,s=0;s<e;s++)!this.data[s].type.match(/(bar|column)/ig)||!this.data[s].visible||this.data[s].type.match(/(stacked)/ig)&&D||(this.data[s].type.match(/(range)/ig)&&(f=!0),D++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;u=this.options.dataPointMaxWidth?this.dataPointMaxWidth:
this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(B?w:1)))<<0:0.3*this.width;f&&(u=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(B?w:1)))<<0:0.03*this.width);s=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(Pa)/Math.log(a.axisX.range):Math.abs(Pa)/Math.abs(a.axisX.range))/(B?w:1))<<
0;this.dataPointMaxWidth&&e>u&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,u));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&u<e)&&(u=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));s<e&&(s=e);s>u&&(s=u);if(0<z.length)for(var E=C._colorSet,u=0;u<z.length;u++){var e=C.lineColor=C.options.color?C.options.color:E[0],K={color:z[u].whiskerColor?z[u].whiskerColor:z[u].color?C.whiskerColor?C.whiskerColor:z[u].color:C.whiskerColor?C.whiskerColor:e,thickness:r(z[u].whiskerThickness)?
C.whiskerThickness:z[u].whiskerThickness,dashType:z[u].whiskerDashType?z[u].whiskerDashType:C.whiskerDashType,length:r(z[u].whiskerLength)?r(C.options.whiskerLength)?s:C.options.whiskerLength:z[u].whiskerLength,trimLength:r(z[u].whiskerLength)?r(C.options.whiskerLength)?50:0:0};K.length="number"===typeof K.length?0>=K.length?0:K.length>=s?s:K.length:"string"===typeof K.length?parseInt(K.length)*s/100>s?s:parseInt(K.length)*s/100>s:s;K.thickness="number"===typeof K.thickness?0>K.thickness?0:Math.round(K.thickness):
2;var aa={color:z[u].stemColor?z[u].stemColor:z[u].color?C.stemColor?C.stemColor:z[u].color:C.stemColor?C.stemColor:e,thickness:z[u].stemThickness?z[u].stemThickness:C.stemThickness,dashType:z[u].stemDashType?z[u].stemDashType:C.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;z[u].getTime?m=z[u].x.getTime():m=z[u].x;if(!(m<a.axisX.dataInfo.viewPortMin||m>a.axisX.dataInfo.viewPortMax)&&!r(z[u].y)&&z[u].y.length&&"number"===typeof z[u].y[0]&&"number"===
typeof z[u].y[1]){var ja=a.axisX.convertValueToPixel(m);b?h=ja:k=ja;ja=a.axisY.convertValueToPixel(z[u].y[0]);b?p=ja:q=ja;ja=a.axisY.convertValueToPixel(z[u].y[1]);b?n=ja:g=ja;b?(q=a.axisX.reversed?h+(B?w:1)*s/2-(B?D-1:0)*s<<0:h-(B?w:1)*s/2+(B?D-1:0)*s<<0,g=a.axisX.reversed?q-s<<0:q+s<<0):(p=a.axisX.reversed?k+(B?w:1)*s/2-(B?D-1:0)*s<<0:k-(B?w:1)*s/2+(B?D-1:0)*s<<0,n=a.axisX.reversed?p-s<<0:p+s<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&p>n&&(ja=p,p=n,n=ja);ja=C.dataPointIds[u];this._eventManager.objectMap[ja]=
{id:ja,objectType:"dataPoint",dataSeriesIndex:F,dataPointIndex:u,x1:Math.min(p,n),y1:Math.min(q,g),x2:Math.max(n,p),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:K};y(c,Math.min(p,n),Math.min(q,g),Math.max(n,p),Math.max(g,q),e,K,aa,b);t&&y(this._eventManager.ghostCtx,p,q,n,g,e,K,aa,b);if(z[u].indexLabel||C.indexLabel||z[u].indexLabelFormatter||C.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:z[u],dataSeries:C,indexKeyword:0,point:{x:b?z[u].y[1]>=z[u].y[0]?
...
l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));p<f&&(p=f);p>l&&(p=l);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],m=g.dataPoints;if(0<m.length){var w=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle=
"#4572A7 ";for(f=0;f<m.length;f++)if(m[f].getTime?h=m[f].x.getTime():h=m[f].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax)&&!r(m[f].y)&&m[f].y.length&&"number"===typeof m[f].y[0]&&"number"===typeof m[f].y[1]){l=a.axisY.convertValueToPixel(m[f].y[0]);u=a.axisY.convertValueToPixel(m[f].y[1]);k=a.axisX.convertValueToPixel(h);k=a.axisX.reversed?k+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:k-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var fa=
a.axisX.reversed?k-p<<0:k+p<<0;l>u&&(b=l,l=u,u=b);b=m[f].color?m[f].color:g._colorSet[f%g._colorSet.length];ba(c,l,k,u,fa,b,0,null,w,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:k,x2:u,y2:fa};b=R(b);t&&ba(this._eventManager.ghostCtx,l,k,u,fa,b,0,null,!1,!1,!1,!1);if(m[f].indexLabel||g.indexLabel||m[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:m[f],
dataSeries:g,indexKeyword:0,point:{x:m[f].y[1]>=m[f].y[0]?l:u,y:k+(fa-k)/2},direction:m[f].y[1]>=m[f].y[0]?-1:1,bounds:{x1:Math.min(l,u),y1:k,x2:Math.max(l,u),y2:fa},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:m[f],dataSeries:g,indexKeyword:1,point:{x:m[f].y[1]>=m[f].y[0]?u:l,y:k+(fa-k)/2},direction:m[f].y[1]>=m[f].y[0]?1:-1,bounds:{x1:Math.min(l,u),y1:k,x2:Math.max(l,u),y2:fa},color:b})}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeArea=
...
this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();t&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();t&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var k=[],h=a.dataSeriesIndexes[u],p=this.data[h],n=p.dataPoints,f=p.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=R(f);e.fillStyle=f;var f=[],q=
!0,g=0,m,r,w,s,x=null;if(0<n.length){var F=p._colorSet[g%p._colorSet.length],C=p.lineColor=p.options.lineColor||F,z=C;b.fillStyle=F;b.strokeStyle=C;b.lineWidth=p.lineThickness;var B="solid";if(b.setLineDash){var y=O(p.nullDataLineDashType,p.lineThickness),B=p.lineDashType,D=O(B,p.lineThickness);b.setLineDash(D)}for(var K=!0;g<n.length;g++)if(s=n[g].x.getTime?n[g].x.getTime():n[g].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!p.connectNullData||!K)))if(null!==n[g].y&&n[g].y.length&&
"number"===typeof n[g].y[0]&&"number"===typeof n[g].y[1]){m=a.axisX.convertValueToPixel(s);r=a.axisY.convertValueToPixel(n[g].y[0]);w=a.axisY.convertValueToPixel(n[g].y[1]);q||K?(p.connectNullData&&!q?(b.setLineDash&&(p.options.nullDataLineDashType||B===p.lineDashType&&p.lineDashType!==p.nullDataLineDashType)&&(k[k.length-1].newLineDashArray=D,B=p.nullDataLineDashType,b.setLineDash(y)),b.lineTo(m,r),t&&e.lineTo(m,r),k.push({x:m,y1:r,y2:w})):(b.beginPath(),b.moveTo(m,r),x={x:m,y:r},k=[],k.push({x:m,
y1:r,y2:w}),t&&(e.beginPath(),e.moveTo(m,r))),K=q=!1):(b.lineTo(m,r),k.push({x:m,y1:r,y2:w}),t&&e.lineTo(m,r),0==g%250&&d());s=p.dataPointIds[g];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:g,x1:m,y1:r,y2:w};g<n.length-1&&(z!==(n[g].lineColor||C)||B!==(n[g].lineDashType||p.lineDashType))&&(d(),z=n[g].lineColor||C,k[k.length-1].newStrokeStyle=z,b.strokeStyle=z,b.setLineDash&&(n[g].lineDashType?(B=n[g].lineDashType,k[k.length-1].newLineDashArray=O(B,
p.lineThickness),b.setLineDash(k[k.length-1].newLineDashArray)):(B=p.lineDashType,k[k.length-1].newLineDashArray=D,b.setLineDash(D))));if(0!==n[g].markerSize&&(0<n[g].markerSize||0<p.markerSize)){var aa=p.getMarkerProperties(g,m,w,b);f.push(aa);var E=R(s);t&&f.push({x:m,y:w,ctx:e,type:aa.type,size:aa.size,color:E,borderColor:E,borderThickness:aa.borderThickness});aa=p.getMarkerProperties(g,m,r,b);f.push(aa);E=R(s);t&&f.push({x:m,y:r,ctx:e,type:aa.type,size:aa.size,color:E,borderColor:E,borderThickness:aa.borderThickness})}if(n[g].indexLabel||
p.indexLabel||n[g].indexLabelFormatter||p.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:n[g],dataSeries:p,indexKeyword:0,point:{x:m,y:r},direction:n[g].y[0]>n[g].y[1]===a.axisY.reversed?-1:1,color:F}),this._indexLabels.push({chartType:"rangeArea",dataPoint:n[g],dataSeries:p,indexKeyword:1,point:{x:m,y:w},direction:n[g].y[0]>n[g].y[1]===a.axisY.reversed?1:-1,color:F})}else K||q||d(),K=!0;d();V.drawMarkers(f)}}t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};
...
d[f+3].y)}}b.beginPath();b.moveTo(d[0].x,d[0].y);t&&(e.beginPath(),e.moveTo(d[0].x,d[0].y));for(f=0;f<d.length-3;f+=3)b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y),t&&e.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=w(fa,2);b.lineTo(fa[fa.length-1].x,fa[fa.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y),t&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();
b.globalAlpha=h.fillOpacity;b.fill();t&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<h.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(r[g].newStrokeStyle||r[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),r[g].newStrokeStyle&&(b.strokeStyle=r[g].newStrokeStyle),r[g].newLineDashArray&&b.setLineDash(r[g].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+
...
f=[],l=this.plotArea;b.save();t&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();t&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var k=0;k<a.dataSeriesIndexes.length;k++){var m=a.dataSeriesIndexes[k],h=this.data[m],p=h.dataPoints,f=h.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:m};f=R(f);e.fillStyle=f;var f=[],n=0,q,g,v,r=[],fa=[];if(0<p.length){var s=h._colorSet[n%h._colorSet.length],x=h.lineColor=h.options.lineColor||s,F=x;b.fillStyle=
s;b.lineWidth=h.lineThickness;var C="solid",z;if(b.setLineDash){var B=O(h.nullDataLineDashType,h.lineThickness),C=h.lineDashType;z=O(C,h.lineThickness)}for(g=!1;n<p.length;n++)if(q=p[n].x.getTime?p[n].x.getTime():p[n].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!g)))if(null!==p[n].y&&p[n].y.length&&"number"===typeof p[n].y[0]&&"number"===typeof p[n].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(p[n].y[0]);v=a.axisY.convertValueToPixel(p[n].y[1]);
var y=h.dataPointIds[n];this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:n,x1:q,y1:g,y2:v};r[r.length]={x:q,y:g};fa[fa.length]={x:q,y:v};n<p.length-1&&(F!==(p[n].lineColor||x)||C!==(p[n].lineDashType||h.lineDashType))&&(F=p[n].lineColor||x,r[r.length-1].newStrokeStyle=F,b.setLineDash&&(p[n].lineDashType?(C=p[n].lineDashType,r[r.length-1].newLineDashArray=O(C,h.lineThickness)):(C=h.lineDashType,r[r.length-1].newLineDashArray=z)));if(0!==p[n].markerSize&&
(0<p[n].markerSize||0<h.markerSize)){var D=h.getMarkerProperties(n,q,g,b);f.push(D);var K=R(y);t&&f.push({x:q,y:g,ctx:e,type:D.type,size:D.size,color:K,borderColor:K,borderThickness:D.borderThickness});D=h.getMarkerProperties(n,q,v,b);f.push(D);K=R(y);t&&f.push({x:q,y:v,ctx:e,type:D.type,size:D.size,color:K,borderColor:K,borderThickness:D.borderThickness})}if(p[n].indexLabel||h.indexLabel||p[n].indexLabelFormatter||h.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:p[n],
dataSeries:h,indexKeyword:0,point:{x:q,y:g},direction:p[n].y[0]<=p[n].y[1]?-1:1,color:s}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:p[n],dataSeries:h,indexKeyword:1,point:{x:q,y:v},direction:p[n].y[0]<=p[n].y[1]?1:-1,color:s});g=!1}else 0<n&&!g&&(h.connectNullData?b.setLineDash&&(0<r.length&&(h.options.nullDataLineDashType||!p[n-1].lineDashType))&&(r[r.length-1].newLineDashArray=B,C=h.nullDataLineDashType):(d(z,x),r=[],fa=[])),g=!0;d(z,x);V.drawMarkers(f)}}t&&(c.drawImage(this._preRenderCanvas,
...
(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>m&&(q=m);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var v=a.dataSeriesIndexes[g],r=this.data[v],w=r.dataPoints,e=r._colorSet[0];r.risingColor=r.options.risingColor?r.options.risingColor:
e;r.fallingColor=r.options.fallingColor?r.options.fallingColor:"#e40a0a";var s="number"===typeof r.options.lineThickness?Math.round(r.lineThickness):1,x=1===Math.round(s)%2?-0.5:0;if(0<w.length)for(var F=5<q&&r.bevelEnabled?!0:!1,C=!1,z=null,B=null,l=0;l<w.length;l++)if(w[l].getTime?p=w[l].x.getTime():p=w[l].x,"number"!==typeof w[l].y){if(0<l&&!C&&r.connectNullData)var y=r.options.nullDataLineDashType||!w[l-1].lineDashType?r.nullDataLineDashType:w[l-1].lineDashType;C=!0}else{k=a.axisX.convertValueToPixel(p);
...
{id:e,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:l,x1:k,y1:m,x2:D,y2:h};var K=w[l].color?w[l].color:0<w[l].y?r.risingColor:r.fallingColor;ba(c,k,m,D,h,K,0,K,F,F,!1,!1,r.fillOpacity);e=R(e);t&&ba(this._eventManager.ghostCtx,k,m,D,h,e,0,null,!1,!1,!1,!1);var aa,K=k;aa="undefined"!==typeof w[l].isIntermediateSum&&!0===w[l].isIntermediateSum||"undefined"!==typeof w[l].isCumulativeSum&&!0===w[l].isCumulativeSum?0<w[l].y?m:h:0<w[l].y?h:m;0<l&&z&&(!C||r.connectNullData)&&(C&&c.setLineDash&&
c.setLineDash(O(y,s)),c.beginPath(),c.moveTo(z,B-x),c.lineTo(K,aa-x),0<s&&c.stroke(),t&&(b.beginPath(),b.moveTo(z,B-x),b.lineTo(K,aa-x),0<s&&b.stroke()));C=!1;z=D;B=0<w[l].y?m:h;K=w[l].lineDashType?w[l].lineDashType:r.options.lineDashType?r.options.lineDashType:"shortDash";c.strokeStyle=w[l].lineColor?w[l].lineColor:r.options.lineColor?r.options.lineColor:"#9e9e9e";c.lineWidth=s;c.setLineDash&&(K=O(K,s),c.setLineDash(K));(w[l].indexLabel||r.indexLabel||w[l].indexLabelFormatter||r.indexLabelFormatter)&&
this._indexLabels.push({chartType:"waterfall",dataPoint:w[l],dataSeries:r,point:{x:k+(D-k)/2,y:0<=w[l].y?m:h},direction:0>w[l].y===a.axisY.reversed?1:-1,bounds:{x1:k,y1:Math.min(m,h),x2:D,y2:Math.max(m,h)},color:e})}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};var X=function(a,d,c,b,e,f,l,k,m){if(!(0>c)){"undefined"===typeof k&&(k=1);if(!t){var h=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===h&&(l-=1E-4)}a.save();a.globalAlpha=k;"pie"===
e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,f,l,!1),0<=m&&a.arc(d.x,d.y,m*c,l,f,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.fill());a.globalAlpha=1;a.restore()}};m.prototype.renderPie=function(a){function d(){if(h&&p){for(var a=0,b=0,c=0,d=0,e=0;e<p.length;e++){var f=p[e],l=h.dataPointIds[e];g[e].id=l;g[e].objectType="dataPoint";g[e].dataPointIndex=
e;g[e].dataSeriesIndex=0;var n=g[e],k={percent:null,total:null},u=null,k=m.getPercentAndTotal(h,f);if(h.indexLabelFormatter||f.indexLabelFormatter)u={chart:m.options,dataSeries:h,dataPoint:f,total:k.total,percent:k.percent};k=f.indexLabelFormatter?f.indexLabelFormatter(u):f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,h,e):h.indexLabelFormatter?h.indexLabelFormatter(u):h.indexLabel?m.replaceKeywordsWithValue(h.indexLabel,f,h,e):f.label?f.label:"";m._eventManager.objectMap[l]=n;n.center={x:F.x,
y:F.y};n.y=f.y;n.radius=B;n.percentInnerRadius=D;n.indexLabelText=k;n.indexLabelPlacement=h.indexLabelPlacement;n.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:h.options.indexLabelLineColor?h.options.indexLabelLineColor:f.color?f.color:h._colorSet[e%h._colorSet.length];n.indexLabelLineThickness=r(f.indexLabelLineThickness)?h.indexLabelLineThickness:f.indexLabelLineThickness;n.indexLabelLineDashType=f.indexLabelLineDashType?f.indexLabelLineDashType:h.indexLabelLineDashType;n.indexLabelFontColor=
f.indexLabelFontColor?f.indexLabelFontColor:h.indexLabelFontColor;n.indexLabelFontStyle=f.indexLabelFontStyle?f.indexLabelFontStyle:h.indexLabelFontStyle;n.indexLabelFontWeight=f.indexLabelFontWeight?f.indexLabelFontWeight:h.indexLabelFontWeight;n.indexLabelFontSize=r(f.indexLabelFontSize)?h.indexLabelFontSize:f.indexLabelFontSize;n.indexLabelFontFamily=f.indexLabelFontFamily?f.indexLabelFontFamily:h.indexLabelFontFamily;n.indexLabelBackgroundColor=f.indexLabelBackgroundColor?f.indexLabelBackgroundColor:
h.options.indexLabelBackgroundColor?h.options.indexLabelBackgroundColor:h.indexLabelBackgroundColor;n.indexLabelMaxWidth=f.indexLabelMaxWidth?f.indexLabelMaxWidth:h.indexLabelMaxWidth?h.indexLabelMaxWidth:0.33*q.width;n.indexLabelWrap="undefined"!==typeof f.indexLabelWrap?f.indexLabelWrap:h.indexLabelWrap;n.startAngle=0===e?h.startAngle?h.startAngle/180*Math.PI:0:g[e-1].endAngle;n.startAngle=(n.startAngle+2*Math.PI)%(2*Math.PI);n.endAngle=n.startAngle+2*Math.PI/C*Math.abs(f.y);f=(n.endAngle+n.startAngle)/
2;f=(f+2*Math.PI)%(2*Math.PI);n.midAngle=f;if(n.midAngle>Math.PI/2-s&&n.midAngle<Math.PI/2+s){if(0===a||g[c].midAngle>n.midAngle)c=e;a++}else if(n.midAngle>3*Math.PI/2-s&&n.midAngle<3*Math.PI/2+s){if(0===b||g[d].midAngle>n.midAngle)d=e;b++}n.hemisphere=f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";n.indexLabelTextBlock=new ia(m.plotArea.ctx,{fontSize:n.indexLabelFontSize,fontFamily:n.indexLabelFontFamily,fontColor:n.indexLabelFontColor,fontStyle:n.indexLabelFontStyle,fontWeight:n.indexLabelFontWeight,
horizontalAlign:"left",backgroundColor:n.indexLabelBackgroundColor,maxWidth:n.indexLabelMaxWidth,maxHeight:n.indexLabelWrap?5*n.indexLabelFontSize:1.5*n.indexLabelFontSize,text:n.indexLabelText,padding:0,textBaseline:"top"});n.indexLabelTextBlock.measureText()}l=f=0;k=!1;for(e=0;e<p.length;e++)n=g[(c+e)%p.length],1<a&&(n.midAngle>Math.PI/2-s&&n.midAngle<Math.PI/2+s)&&(f<=a/2&&!k?(n.hemisphere="right",f++):(n.hemisphere="left",k=!0));k=!1;for(e=0;e<p.length;e++)n=g[(d+e)%p.length],1<b&&(n.midAngle>
3*Math.PI/2-s&&n.midAngle<3*Math.PI/2+s)&&(l<=b/2&&!k?(n.hemisphere="left",l++):(n.hemisphere="right",k=!0))}}function c(a){var b=m.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=m.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(b=0;b<p.length;b++){var c=g[b].startAngle,d=g[b].endAngle;if(d>c){var e=0.07*B*Math.cos(g[b].midAngle),f=0.07*B*Math.sin(g[b].midAngle),l=!1;if(p[b].exploded){if(1E-9<Math.abs(g[b].center.x-(F.x+e))||1E-9<Math.abs(g[b].center.y-(F.y+f)))g[b].center.x=
F.x+e*a,g[b].center.y=F.y+f*a,l=!0}else if(0<Math.abs(g[b].center.x-F.x)||0<Math.abs(g[b].center.y-F.y))g[b].center.x=F.x+e*(1-a),g[b].center.y=F.y+f*(1-a),l=!0;l&&(e={},e.dataSeries=h,e.dataPoint=h.dataPoints[b],e.index=b,m.toolTip.highlightObjects([e]));X(m.plotArea.ctx,g[b].center,g[b].radius,p[b].color?p[b].color:h._colorSet[b%h._colorSet.length],h.type,c,d,h.fillOpacity,g[b].percentInnerRadius)}}a=m.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin=
...
q.y1,q.width,q.height);for(var b=g[0].startAngle+2*Math.PI*a,c=0;c<p.length;c++){var d=0===c?g[c].startAngle:e,e=d+(g[c].endAngle-g[c].startAngle),f=!1;e>b&&(e=b,f=!0);var l=p[c].color?p[c].color:h._colorSet[c%h._colorSet.length];e>d&&X(m.plotArea.ctx,g[c].center,g[c].radius,l,h.type,d,e,h.fillOpacity,g[c].percentInnerRadius);if(f)break}k();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});1<=a&&m.dispatchEvent("dataAnimationEnd",{chart:m})},function(){m.disableToolTip=!1;m._animator.animate(0,
...
p)),d.push(n);return d}function b(){if(s&&x){for(var a,b,c,d,e,f,h,l,k,n,p,q,m,u,v=[],A=[],w={percent:null,total:null},B=null,z=0;z<x.length;z++)u=P[z],u="undefined"!==typeof u.x5?(u.y2+u.y4)/2:(u.y2+u.y3)/2,u=g(u).x2+1,v[z]=N-u-U;u=0.5*U;for(var z=0,F=x.length-1;z<x.length||0<=F;z++,F--){b=s.reversed?x[F]:x[z];a=b.color?b.color:s.reversed?s._colorSet[(x.length-1-z)%s._colorSet.length]:s._colorSet[z%s._colorSet.length];c=b.indexLabelPlacement||s.indexLabelPlacement||"outside";d=b.indexLabelBackgroundColor||
...
s.indexLabelLineThickness:2;p=b.indexLabelLineDashType||s.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof s.indexLabelWrap?s.indexLabelWrap:!0;m=s.dataPointIds[z];y._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:P[s.reversed?x.length-1-z:z]};"inside"===s.indexLabelPlacement&&(v[z]=z!==ba?s.reversed?P[z].x2-P[z].x1:P[z].x3-P[z].x4:P[z].x3-P[z].x6,20>v[z]&&(v[z]=z!==ba?s.reversed?
P[z].x3-P[z].x4:P[z].x2-P[z].x1:P[z].x2-P[z].x1,v[z]/=2));m=b.indexLabelMaxWidth?b.indexLabelMaxWidth:s.options.indexLabelMaxWidth?s.indexLabelMaxWidth:v[z];if(m>v[z]||0>m)m=v[z];A[z]="inside"===s.indexLabelPlacement?P[z].height:!1;w=y.getPercentAndTotal(s,b);if(s.indexLabelFormatter||b.indexLabelFormatter)B={chart:y.options,dataSeries:s,dataPoint:b,total:w.total,percent:w.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(B):b.indexLabel?y.replaceKeywordsWithValue(b.indexLabel,b,s,z):s.indexLabelFormatter?
s.indexLabelFormatter(B):s.indexLabel?y.replaceKeywordsWithValue(s.indexLabel,b,s,z):b.label?b.label:"";0>=n&&(n=0);1E3>m&&1E3-m<u&&(m+=1E3-m);R.roundRect||Ba(R);c=new ia(R,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:h,fontWeight:k,horizontalAlign:c,backgroundColor:d,maxWidth:m,maxHeight:!1===A[z]?q?4.28571429*f:1.5*f:A[z],text:b,padding:ca});c.measureText();I.push({textBlock:c,id:s.reversed?F:z,isDirty:!1,lineColor:a,lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,
width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,h=N-Z-U/2,h=s.options.indexLabelMaxWidth?s.indexLabelMaxWidth>h?h:s.indexLabelMaxWidth:h,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<P.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+ca>b.y&&(e=!0);c=g.indexLabelMaxWidth||h;if(c>h||0>c)c=h;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=P[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=
N-h,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,s.reversed?(I[l].textBlock.y+I[l].height>ma+C&&(I[l].textBlock.y=ma+C-I[l].height),I[l].textBlock.y<ra-C&&(I[l].textBlock.y=ra-C)):(I[l].textBlock.y<ma-C&&(I[l].textBlock.y=ma-C),I[l].textBlock.y+
I[l].height>ra+C&&(I[l].textBlock.y=ra+C-I[l].height))}function f(){var a,b,c,d;if("inside"!==s.indexLabelPlacement)for(var e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=s.reversed?"undefined"!==typeof a.x5?c>wa?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<wa?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+U,I[e].textBlock.y=c-I[e].height/2,s.reversed?(I[e].textBlock.y+I[e].height>
ma+C&&(I[e].textBlock.y=ma+C-I[e].height),I[e].textBlock.y<ra-C&&(I[e].textBlock.y=ra-C)):(I[e].textBlock.y<ma-C&&(I[e].textBlock.y=ma-C),I[e].textBlock.y+I[e].height>ra+C&&(I[e].textBlock.y=ra+C-I[e].height)));else for(e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=ba?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ba?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=c):I[e].isDirty=!0)}function l(){function a(b,
c){var d;if(0>b||b>=I.length)return 0;var e,f=I[b].textBlock;if(0>c){c*=-1;e=n(b);d=k(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=k(b,e);if(d>=c)return f.y+=c,c;if(b==P.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,h;f=(S-Y+2*C)/p;h=p;for(var l,k=1;k<h;k++){e=k*f;for(var m=I.length-1;0<=m;m--)!I[m].isDirty&&(I[m].textBlock.y<e&&I[m].textBlock.y+I[m].height>e)&&(l=q(m),!(l>=I.length-1)&&
I[m].textBlock.y+I[m].height+ca>I[l].textBlock.y&&(I[m].textBlock.y=I[m].textBlock.y+I[m].height-e>e-I[m].textBlock.y?e+1:e-I[m].height-1))}for(l=P.length-1;0<l;l--)if(!I[l].isDirty){e=n(l);if(0>e&&(e=0,I[e].isDirty))break;if(I[l].textBlock.y<I[e].textBlock.y+I[e].height){d=d||l;f=l;for(h=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+ca;){a=a||I[f].textBlock.y+I[f].height;h+=I[f].height;h+=ca;f=e;if(0>=f){f=0;h+=I[f].height;break}e=n(f);if(0>e){f=0;h+=I[f].height;break}}if(f!=l){g=I[f].textBlock.y;
a-=g;a=h-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(P[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=I[b.id].height+ca,I[b.id].textBlock.text="",I[b.id].indexLabelText="",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,h,l,p=1,m=0;m<2*p;m++){for(var s=I.length-1;0<=s&&!(0<=n(s)&&n(s),f=I[s],g=f.textBlock,l=(h=q(s)<P.length?I[q(s)]:null)?h.textBlock:null,d=
+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(h&&e+d+ca>+l.y.toFixed(6))&&(d=g.y+d+ca-l.y,e=a(s,-d),e<d&&(0<e&&(d-=e),e=a(q(s),d),e!=d)));s--);b()}}function k(a,b){return(b<P.length?I[b].textBlock.y:s.reversed?ma+C:ra+C)-(0>a?s.reversed?ra-C:ma-C:I[a].textBlock.y+I[a].height+ca)}function m(a,b,c){var d,e,g,l=[],k=C,n=[];-1!==b&&(0<=X.indexOf(b)?(e=X.indexOf(b),X.splice(e,1)):(X.push(b),X=X.sort(function(a,b){return a-b})));if(0===X.length)l=ga;else{e=C*(1!=X.length||0!=X[0]&&X[0]!=P.length-
1?2:1)/h();for(var q=0;q<P.length;q++){if(1==X.length&&0==X[0]){if(0===q){l.push(ga[q]);d=k;continue}}else 0===q&&(d=-1*k);l.push(ga[q]+d);if(0<=X.indexOf(q)||q<P.length&&0<=X.indexOf(q+1))d+=e}}g=function(){for(var a=[],b=0;b<P.length;b++)a.push(l[b]-P[b].y1);return a}();var u={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return L.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<P.length;d++)b=g[d],c=P[d],b*=a,"undefined"===typeof n[d]&&
...
P[e],s.fillOpacity);w(d);K&&("inside"!==s.indexLabelPlacement?p(d):f(),v(d));1<=c&&(ha=!1)},null,L.easing.easeOutQuart)}function h(){for(var a=0,b=0;b<P.length-1;b++)(0<=X.indexOf(b)||0<=X.indexOf(b+1))&&a++;return a}function p(a){for(var b,c,d,e,f=0;f<P.length;f++)e=1===I[f].lineThickness%2?0.5:0,c=((P[f].y2+P[f].y4)/2<<0)+e,b=g(c).x2-1,d=I[f].textBlock.x,e=(I[f].textBlock.y+I[f].height/2<<0)+e,I[f].isDirty||0==I[f].lineThickness||(a.strokeStyle=I[f].lineColor,a.lineWidth=I[f].lineThickness,a.setLineDash&&
...
0;b<P.length;b++)I[b].isDirty||(a&&(I[b].textBlock.ctx=a),I[b].textBlock.render(!0))}function w(a){y.plotArea.layoutManager.reset();a.roundRect||Ba(a);y.title&&(y.title.dockInsidePlotArea||"center"===y.title.horizontalAlign&&"center"===y.title.verticalAlign)&&(y.title.ctx=a,y.title.render());if(y.subtitles)for(var b=0;b<y.subtitles.length;b++){var c=y.subtitles[b];if(c.dockInsidePlotArea||"center"===c.horizontalAlign&&"center"===c.verticalAlign)y.subtitles.ctx=a,c.render()}y.legend&&(y.legend.dockInsidePlotArea||
"center"===y.legend.horizontalAlign&&"center"===y.legend.verticalAlign)&&(y.legend.ctx=a,y.legend.setLayout(),y.legend.render());J.fNg&&J.fNg(y)}var y=this;if(!(0>=a.dataSeriesIndexes.length)){for(var s=this.data[a.dataSeriesIndexes[0]],x=s.dataPoints,F=this.plotArea,C=0.025*F.width,z=0.01*F.width,B=0,D=F.height-2*C,E=Math.min(F.width-2*z,2.8*F.height),K=!1,H=0;H<x.length;H++)if(!K&&("undefined"!==typeof x[H].indexLabel&&null!==x[H].indexLabel&&0<x[H].indexLabel.toString().length)&&(K=!0),!K&&("undefined"!==
typeof x[H].label&&null!==x[H].label&&0<x[H].label.toString().length)&&(K=!0),!K&&"function"===typeof s.indexLabelFormatter||"function"===typeof x[H].indexLabelFormatter)K=!0;K=K||"undefined"!==typeof s.indexLabel&&null!==s.indexLabel&&0<s.indexLabel.toString().length;"inside"!==s.indexLabelPlacement&&K||(z=(F.width-0.75*E)/2);var H=F.x1+z,N=F.x2-z,Y=F.y1+C,S=F.y2-C,R=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=s.length&&(s.dataPoints&&s.visible)&&0!==x.length){var Q,G;a=75*E/100;var U=30*
(N-a)/100;"funnel"===s.type?(Q=r(s.options.neckHeight)?0.35*D:s.neckHeight,G=r(s.options.neckWidth)?0.25*a:s.neckWidth,"string"===typeof Q&&Q.match(/%$/)?(Q=parseInt(Q),Q=Q*D/100):Q=parseInt(Q),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),Q>D?Q=D:0>=Q&&(Q=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===s.type&&(G=Q=0,s.reversed=s.reversed?!1:!0);var z=H+a/2,W=H,Z=H+a,ma=s.reversed?S:Y,M=z-G/2,V=z+G/2,wa=s.reversed?Y+Q:S-Q,ra=s.reversed?Y:S;a=[];var z=[],P=[],E=[],T=Y,ba,$=(wa-
ma)/(M-W),da=-$,H="area"===(s.valueRepresents?s.valueRepresents:"height")?c():d();if(-1!==H){if(s.reversed)for(E.push(T),G=H.length-1;0<G;G--)T+=H[G],E.push(T);else for(G=0;G<H.length;G++)T+=H[G],E.push(T);if(s.reversed)for(G=0;G<H.length;G++)E[G]<wa?(a.push(M),z.push(V),ba=G):(a.push((E[G]-ma+$*W)/$),z.push((E[G]-ma+da*Z)/da));else for(G=0;G<H.length;G++)E[G]<wa?(a.push((E[G]-ma+$*W)/$),z.push((E[G]-ma+da*Z)/da),ba=G):(a.push(M),z.push(V));for(G=0;G<H.length-1;G++)T=s.reversed?x[x.length-1-G].color?
x[x.length-1-G].color:s._colorSet[(x.length-1-G)%s._colorSet.length]:x[G].color?x[G].color:s._colorSet[G%s._colorSet.length],G===ba?P.push({x1:a[G],y1:E[G],x2:z[G],y2:E[G],x3:V,y3:wa,x4:z[G+1],y4:E[G+1],x5:a[G+1],y5:E[G+1],x6:M,y6:wa,id:G,height:E[G+1]-E[G],color:T}):P.push({x1:a[G],y1:E[G],x2:z[G],y2:E[G],x3:z[G+1],y3:E[G+1],x4:a[G+1],y4:E[G+1],id:G,height:E[G+1]-E[G],color:T});var ca=2,I=[],ha=!1,X=[],ga=[],H=!1;a=a=0;Ca(X);for(G=0;G<x.length;G++)x[G].exploded&&(H=!0,s.reversed?X.push(x.length-
1-G):X.push(G));R.clearRect(F.x1,F.y1,F.width,F.height);R.fillStyle=y.backgroundColor;R.fillRect(F.x1,F.y1,F.width,F.height);if(K&&s.visible&&(b(),f(),e(),"inside"!==s.indexLabelPlacement)){l();for(G=0;G<x.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(N-a)/2,0==G&&(B=a),B>a&&(B=a));for(G=0;G<P.length;G++)P[G].x1+=B,P[G].x2+=B,P[G].x3+=B,P[G].x4+=B,P[G].x5&&(P[G].x5+=B,P[G].x6+=B),I[G].textBlock.x+=B}for(G=0;G<P.length;G++)B=P[G],pa(R,B,s.fillOpacity),ga.push(B.y1);w(R);K&&s.visible&&
("inside"===s.indexLabelPlacement||y.animationEnabled||p(R),y.animationEnabled||v());if(!K)for(G=0;G<x.length;G++)B=s.dataPointIds[G],a={id:B,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:P[s.reversed?x.length-1-G:G]},y._eventManager.objectMap[B]=a;!y.animationEnabled&&H?m(y,-1,0):y.animationEnabled&&!y.animatedRender&&m(y,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ha&&!y.isAnimating&&(r(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=s.reversed?
x.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===s.type||"pyramid"===s.type)s.reversed?x[x.length-1-a].exploded=x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;m(y,b,500)}};return{source:R,dest:this.plotArea.ctx,animationCallback:function(a,b){L.fadeInAnimation(a,b);1<=a&&(m(y,-1,500),w(y.plotArea.ctx||y.ctx))},easingFunction:L.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||
...
do{m="";if(c.percentFormatString)m=c.percentFormatString;else{var m="#,##0.",h=Math.max(Math.ceil(Math.log(1/Math.abs(l))/Math.LN10),2);if(isNaN(h)||!isFinite(h))h=2;for(var p=0;p<h;p++)m+="#";c.percentFormatString=m}a=a.replace("#percent",da(l,m,f._cultureInfo));a=a.replace("#total",da(k,c.yValueFormatString?c.yValueFormatString:"#,##0.########",f._cultureInfo))}while(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))}return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,function(a){if('"'===a[0]&&'"'===a[a.length-
1]||"'"===a[0]&&"'"===a[a.length-1])return a.slice(1,a.length-1);a=Fa(a.slice(1,a.length-1));a=a.replace("#index",e);var h=null;try{var g=a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);g&&0<g.length&&(h=Fa(g[2]),a=Fa(g[1]))}catch(l){}g=null;if("color"===a)return"waterfall"===c.type?d.color?d.color:0<d.y?c.risingColor:c.fallingColor:"error"===c.type?c.color?c.color:c._colorSet[h%c._colorSet.length]:d.color?d.color:c.color?c.color:c._colorSet[b%c._colorSet.length];if(d.hasOwnProperty(a))g=d;else if(c.hasOwnProperty(a))g=
c;else return"";g=g[a];null!==h&&(g=g[h]);if("x"===a)if("dateTime"===c.axisX.valueType||"dateTime"===c.xValueType||d.x&&d.x.getTime){if(!c.axisX.logarithmic)return za(g,d.xValueFormatString?d.xValueFormatString:c.xValueFormatString?c.xValueFormatString:c.xValueFormatString=f.axisX&&f.axisX.autoValueFormatString?f.axisX.autoValueFormatString:"DD MMM YY",f._cultureInfo)}else return da(g,d.xValueFormatString?d.xValueFormatString:c.xValueFormatString?c.xValueFormatString:c.xValueFormatString="#,##0.########",
f._cultureInfo);else return"y"===a?da(g,d.yValueFormatString?d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",f._cultureInfo):"z"===a?da(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};na(E,U);E.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,k=this.markerMargin=
...
n._linkedSeries.legendMarkerType?n._linkedSeries.legendMarkerType:H.getDefaultLegendMarker(n._linkedSeries.type):H.getDefaultLegendMarker(n.type):n.markerType,g=n.legendText?n.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:n,dataPoint:null}):n.name,v=n.legendMarkerColor=n.legendMarkerColor?n.legendMarkerColor:n.markerColor?n.markerColor:"error"===n.type?r(n.whiskerColor)?n._colorSet[0]:n.whiskerColor:n._colorSet[0],t=n.markerSize||"line"!==
n.type&&"stepLine"!==n.type&&"spline"!==n.type?0.75*this.lineHeight:0,w=n.legendMarkerBorderColor?n.legendMarkerBorderColor:n.markerBorderColor,s=n.legendMarkerBorderThickness?n.legendMarkerBorderThickness:n.markerBorderThickness?Math.max(1,Math.round(0.2*t)):0;"error"===n.type&&this.errorMarkerColor.push(v);g=this.chart.replaceKeywordsWithValue(g,n.dataPoints[0],n,p);q={markerType:q,markerColor:v,text:g,textBlock:null,chartType:n.type,markerSize:t,lineColor:n._colorSet[0],dataSeriesIndex:n.index,
dataPointIndex:null,markerBorderColor:w,markerBorderThickness:s};m.push(q)}else for(var x=0;x<n.dataPoints.length;x++){var y=n.dataPoints[x],q=y.legendMarkerType?y.legendMarkerType:n.legendMarkerType?n.legendMarkerType:H.getDefaultLegendMarker(n.type),g=y.legendText?y.legendText:n.legendText?n.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:n,dataPoint:y}):y.name?y.name:"DataPoint: "+(x+1),v=y.legendMarkerColor?y.legendMarkerColor:n.legendMarkerColor?
...
0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=f/8;this.ctx.beginPath();var w=g-0.08*this.lineHeight+0.1*this.lineHeight,s=r+0.15*this.lineHeight,x=0.7*this.lineHeight,y=x+0.02*this.lineHeight;this.ctx.moveTo(w,s);this.ctx.lineTo(w+x,s);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w+x/2,s);this.ctx.lineTo(w+x/2,s+y);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w,s+y);this.ctx.lineTo(w+x,s+y);this.ctx.stroke();this.errorMarkerColor.shift()}V.drawMarker(g+
...
2}k+=p}};na(H,U);H.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"normal";if("bar"===a||"stackedBar"===
...
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),k=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var t=ka("markerSize",g,this)||4,w=c?20:t,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=
Math.abs(q.x1-a);q<=m?m=q:0<l?h++:p++;r<=t/2&&(k=!0);break;case "rangeArea":case "rangeSplineArea":t=ka("markerSize",g,this)||4;w=c?20:t;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?h++:p++;r<=t/2&&(k=!0);break;case "bubble":t=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=t/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
...
k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||r(B)||r(D)||p.isNavigator||p.stockChart)||(k=0,0<a[g].labelAngle?D+s>m&&(k+=0<a[g].labelAngle?D+s-m-$:0):0>a[g].labelAngle?B-w<l&&B-w<a[g].viewportMinimum&&(E=l-(M+a[g].tickLength+C+B-w+a[g].labelFontSize/2)):0===a[g].labelAngle&&(D+s>m&&(k=D+s/2-m-$),B-w<l&&B-w<a[g].viewportMinimum&&(E=l-M-a[g].tickLength-C-B+w/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
0<k?m-=k:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<E?l+=E:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<E&&(l+=E),0<k&&(m-=k))),p.panEnabled?T=r(p.sessionVariables.axisX.height)?p.sessionVariables.axisX.height=T:p.sessionVariables.axisX.height:p.sessionVariables.axisX.height=T,k=Math.round(f.y2-T-e+G),h=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=
k,a[g].lineCoordinates.y2=k+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+x[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:k,x2:m,y2:h-(T+e-x[g]-G),width:m-l,height:h-k}),G+=x[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+P+M),d[g].lineCoordinates.x2=
...
k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle))),p.panEnabled?V=r(p.sessionVariables.axisX2.height)?p.sessionVariables.axisX2.height=V:p.sessionVariables.axisX2.height:p.sessionVariables.axisX2.height=V,k=Math.round(f.y1),h=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=k+V+W-S,d[g].lineCoordinates.y2=k,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-y[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:k+(V+
W-y[g]-S),x2:m,y2:h,width:m-l,height:h-k},S+=y[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)M=p.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:n,k=Math.round(f.y1+V+W<Math.max(M,n)?Math.max(M,n):f.y1+V+W),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:n,h=Math.round(f.y2-T-e-M),c[g].lineCoordinates={x1:l-U,y1:k,x2:m-U,y2:h,height:Math.abs(h-k)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(C[g]-c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(C[g]+U),y1:k,x2:m,y2:h,width:m-l,height:h-k},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),U+=C[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),M=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,k=Math.round(f.y1+V+W<Math.max(M,n)?Math.max(M,n):f.y1+V+W),M=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,h=Math.round(f.y2-(T+e+M)),b[g].lineCoordinates=
{x1:l+X,y1:k,x2:l+X,y2:h,height:Math.abs(h-k)},"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.x1=b[g].lineCoordinates.x1+(z[g]-b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)-("outside"===b[g].tickPlacement?b[g].tickLength:0)-2,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/2),b[g].bounds={x1:l,y1:k,x2:m+(z[g]+X),y2:h,width:m-l,height:h-k},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.height?b[g].titleMaxWidth:
b[g].lineCoordinates.height),X+=z[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++)a[g]&&(a[g].calculateValueToPixelConversionParameters(),a[g].calculateBreaksSizeInValues(),a[g]._labels&&1<a[g]._labels.length&&(B=(a[g].logarithmic?Math.log(a[g]._labels[1].position/a[g].viewportMinimum)/a[g].conversionParameters.lnLogarithmBase:a[g]._labels[1].position-a[g].viewportMinimum)*Math.abs(a[g].conversionParameters.pixelPerUnit)+a[g].lineCoordinates.x1,l=a[g]._labels[a[g]._labels.length-("dateTime"===
...
(0<l?l*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<t){if(a&&0<a.length)for(g=0;g<a.length;g++)v=N[t-1][g]===N[t][g]?!0:!1;else v=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=O[t-1][g]===O[t][g]?!0:!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=Q[t-1][g]===Q[t][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=R[t-
1][g]===R[t][g]?!0:!1;else L=!0}if(v&&H&&J&&L)break;t++}if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateStripLinesThicknessInValues(),d[g].calculateBreaksInPixels();if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels()}else{n=
[];B=[];E=[];w=[];D=[];s=[];N=[];for(O=[];4>t;){T=X=S=U=Z=M=W=e=R=Q=G=V=0;if(a&&0<a.length)for(E=[],g=X=0;g<a.length;g++)E.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),X+=E[g],e+=a[g]&&!p.isNavigator?a[g].margin:0;else E.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));N.push(E);if(d&&0<d.length)for(w=[],g=T=0;g<d.length;g++)w.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),T+=w[g],W+=d[g]?d[g].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));O.push(w);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+X+e),m=Math.round(f.x2-T-W>p.width-10?p.width-10:f.x2-T-W),c[g].labelAutoFit&&!r(x)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,x):0===c[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-y/2:0===c[g].labelAngle?m-y/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+X+e),m=Math.round(f.x2-T-W>b[g].chart.width-10?b[g].chart.width-10:f.x2-T-W),b[g]&&b[g].labelAutoFit&&!r(C)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,C):0===b[g].labelAngle?Math.max(l,C/2):l),0<!d.length&&(m-=z/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(n=[],g=U=0;g<c.length;g++)n.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),U+=n[g]+c[g].margin,M+=c[g].margin;else n.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));D.push(n);if(b&&0<b.length)for(B=[],g=S=0;g<b.length;g++)B.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),S+=B[g],Z+=b[g].margin;else B.push(Math.ceil(b[0]?
...
p.sessionVariables.axisY.height=n[g]:p.sessionVariables.axisY.height;else for(g=0;g<c.length;g++)p.sessionVariables.axisY.height=n[g];if(c&&0<c.length)for(g=c.length-1;0<=g;g--)k=Math.round(f.y2),h=Math.round(f.y2>c[g].chart.height?c[g].chart.height:f.y2),c[g].lineCoordinates.y1=k-(n[g]+c[g].margin+V),c[g].lineCoordinates.y2=k-(n[g]+c[g].margin+V),"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.y1=c[g].lineCoordinates.y1+n[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)-("inside"===
c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),c[g].bounds={x1:l,y1:k-(n[g]+V+c[g].margin),x2:m,y2:h-(V+c[g].margin),width:m-l,height:n[g]},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width),V+=n[g]+c[g].margin;if(b&&0<b.length)for(g=b.length-1;0<=g;g--)b[g]&&(k=Math.round(f.y1),h=Math.round(f.y1+(B[g]+b[g].margin+G)),b[g].lineCoordinates.y1=
...
0>c[M].labelAngle||0===c[M].labelAngle?m-X:l);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(m=b[M].lineCoordinates.x1,l=m-X);a[g].lineCoordinates={x1:m-Q,y1:k,x2:m-Q,y2:h,height:Math.abs(h-k)};"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-(E[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0))+("outside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:m-(E[g]+
Q),y1:k,x2:m,y2:h,width:m-l,height:h-k};a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();Q+=E[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){M=d[g]._labels&&0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1-e);k=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<
Math.max(M,10)?Math.max(M,10):f.y1):f.y1<Math.max(M,10)?Math.max(M,10):f.y1;m=Math.round(f.x2-T-W);h=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-U>p.height-Math.max(M,10)?p.height-Math.max(M,10):f.y2-U):f.y2>p.height-Math.max(M,10)?p.height-Math.max(M,10):f.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(m=0>c[M].labelAngle?Math.max(m,x):0===c[M].labelAngle?Math.max(m,x/2):m,l=0>c[M].labelAngle||0===c[M].labelAngle?m-T:l);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&
b[M].labelAutoFit&&(m=b[M].lineCoordinates.x2,l=m-T);d[g].lineCoordinates={x1:m+R,y1:k,x2:m+R,y2:h,height:Math.abs(h-k)};"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.x1=d[g].lineCoordinates.x1+(w[g]-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)-2)-("outside"===d[g].tickPlacement?d[g].tickLength:0),d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+d[g].lineThickness/2);d[g].bounds={x1:d[g].lineCoordinates.x1,y1:k,x2:m+w[g]+R,y2:h,width:m-l,height:h-k};d[g].title&&(d[g]._titleTextBlock.maxWidth=
0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.height?d[g].titleMaxWidth:d[g].lineCoordinates.height);d[g].calculateValueToPixelConversionParameters();d[g].calculateBreaksSizeInValues();R+=w[g]+d[g].margin}for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<t){if(a&&0<a.length)for(g=0;g<a.length;g++)v=N[t-1][g]===N[t][g]?!0:!1;else v=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=O[t-1][g]===O[t][g]?!0:
!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=D[t-1][g]===D[t][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=s[t-1][g]===s[t][g]?!0:!1;else L=!0}if(v&&H&&J&&L)break;t++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
this.conversionParameters.maximum/this.conversionParameters.minimum:this.conversionParameters.maximum-this.conversionParameters.minimum),b=this.scaleBreaks&&!r(this.scaleBreaks.options.spacing),e,f=0;f<d.length;f++)e=b||!r(d[f].options.spacing),d[f].spacing=Sa(d[f].spacing,a,8,e?0.1*a:8,e?0:3)<<0,d[f].size=0>d[f].spacing?0:Math.abs(d[f].spacing/c),this.logarithmic&&(d[f].size=Math.pow(this.logarithmBase,d[f].size))};D.prototype.calculateBreaksInPixels=function(){if(!(this.scaleBreaks&&0>=this.scaleBreaks._appliedBreaks.length)){var a=
...
0<this.scaleBreaks._appliedBreaks.length){var a=this.scaleBreaks._appliedBreaks;t?(this.maskCanvas=sa(this.chart.width,this.chart.height),this.maskCtx=this.maskCanvas.getContext("2d")):(this.maskCanvas=this.chart.plotArea.canvas,this.maskCtx=this.chart.plotArea.ctx);this.maskCtx.save();this.maskCtx.beginPath();this.maskCtx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.maskCtx.clip();for(var d=0;d<a.length;d++)a[d].endValue<this.viewportMinimum||
...
d.lineWidth=this.lineThickness;d.strokeStyle=this.lineColor?this.lineColor:"black";d.setLineDash&&d.setLineDash(O(this.lineDashType,this.lineThickness));var l=1===this.lineThickness%2?(this.lineCoordinates.y1<<0)+0.5:this.lineCoordinates.y1<<0;d.beginPath();if(this.scaleBreaks&&!r(this.scaleBreaks.firstBreakIndex))if(r(this.scaleBreaks.lastBreakIndex))e=this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel+b;else for(var k=this.scaleBreaks.firstBreakIndex;k<=this.scaleBreaks.lastBreakIndex;k++)d.moveTo(e,
...
a?(this.interval=3,this.intervalType="month"):b/(6*S.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=b/(1*S.yearDuration)<=a?1:b/(2*S.yearDuration)<=a?2:b/(4*S.yearDuration)<=a?4:Math.floor(D.getNiceNumber(b/(a-1),!0)/S.yearDuration),this.intervalType="year"));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=e-l/2;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=f+l/2;d?this.autoValueFormatString="MMM DD YYYY HH:mm":
...
D.prototype.getLabelStartPoint=function(){var a=S[this.intervalType+"Duration"]*this.interval,a=new Date(Math.floor(this.viewportMinimum/a)*a);if("millisecond"!==this.intervalType)if("second"===this.intervalType)0<a.getMilliseconds()&&(a.setSeconds(a.getSeconds()+1),a.setMilliseconds(0));else if("minute"===this.intervalType){if(0<a.getSeconds()||0<a.getMilliseconds())a.setMinutes(a.getMinutes()+1),a.setSeconds(0),a.setMilliseconds(0)}else if("hour"===this.intervalType){if(0<a.getMinutes()||0<a.getSeconds()||
...
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;R(this.id);var f,l,k,m,h,p;a=Math.max(this.spacing,3);var n=Math.max(0,this.lineThickness);this.ctx.lineWidth=n;this.ctx.setLineDash&&this.ctx.setLineDash(O(this.lineDashType,n));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===n%2?(b.x<<0)+0.5:b.x<<0,l=1===n%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,k=this.chart.plotArea.y2+
...
this.chart.toolTip&&this.chart.toolTip._entries&&this.chart.toolTip.highlightObjects(this.chart.toolTip._entries);return c};$.prototype.hide=function(){this.chart.resetOverlayedCanvas();this.chart.renderCrosshairs(this.parent);this._hidden=!0};$.prototype.render=function(a,d,c){var b,e,f,l,k=null,m=null,h=null,p="";if(!this.valueFormatString)if("dateTime"===this.parent.valueType)this.valueFormatString=this.parent.valueFormatString;else{var n=0,n="xySwapped"===this.chart.plotInfo.axisPlacement?50<
...
for(v=s=0;v<x.dataPoint.y.length;v++)s=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[v])),s<t&&(t=s,b=v);k=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;this.value=x.dataPoint.y[b];h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):r(this.options.label)?da(c?c:x.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):
this.label}else if("stackedBar"===this.parent.dataSeries[w].type){t=Math.abs(a-this.parent.convertValueToPixel(p[0].dataPoint.y));y=s=0;for(v=w;0<=v;v--)y+=p[v].dataPoint.y,s=Math.abs(a-this.parent.convertValueToPixel(y)),s<t&&(t=s,b=v);k=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;this.value=y;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):r(this.options.label)?
da(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[w].type){t=Math.abs(a-this.parent.convertValueToPixel(p[0].dataPoint.y));C=y=s=0;for(v=w;0<=v;v--)y+=p[v].dataPoint.y,C=p[v].dataPoint.x.getTime?p[v].dataPoint.x.getTime():p[v].dataPoint.x,C=100*(y/p[v].dataSeries.plotUnit.dataPointYSums[C]),s=Math.abs(a-this.parent.convertValueToPixel(C)),s<t&&(t=s,b=v);k=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<
0;this.value=C;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:C}):r(this.options.label)?da(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label}else k=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y)<<0,this.value=x.dataPoint.y,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:c?c:x.dataPoint.y}):r(this.options.label)?da(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=k;f=this.chart.plotArea.y1;l=this.chart.plotArea.y2;this.bounds={x1:b-n/2,y1:f,x2:e+n/2,y2:l};h.x=b-h.measureText().width/2;h.x+h.width>this.chart.bounds.x2?h.x=this.chart.bounds.x2-h.width:h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1);h.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-h.height+this.parent.tickLength:h.fontSize/2)+2;h.y+h.height>
this.chart.bounds.y2?h.y=this.chart.bounds.y2-h.height:h.y<this.chart.bounds.y1&&(h.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){f=l=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-n/2,x2:e,y2:l+n/2};C=!1;if(this.parent.labels)for(p=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=
p)if(this.parent.labels[v])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({y:d}),t=null,w=0;w<this.parent.dataSeries.length;w++)(t=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=t.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?t.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):r(this.options.label)?za(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):r(this.options.label)?da(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=x.dataPoint.x;h.y=l+h.fontSize/2-h.measureText().height/
2+2;h.y-h.fontSize/2<this.chart.bounds.y1?h.y=this.chart.bounds.y1+h.fontSize/2+2:h.y+h.measureText().height-h.fontSize/2>this.chart.bounds.y2&&(h.y=this.chart.bounds.y2-h.measureText().height+h.fontSize/2);"left"===this.parent._position?h.x=this.parent.lineCoordinates.x2-h.measureText().width:"right"===this.parent._position&&(h.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){v=this.parent.convertPixelToValue({x:a});for(w=0;w<this.parent.dataSeries.length;w++)(t=
this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=t.index&&(t.dataSeries=this.parent.dataSeries[w],null!==t.dataPoint.y&&t.dataSeries.visible&&p.push(t));if(0===p.length)return;p.sort(function(a,b){return a.distance-b.distance});x=p[0];b=e=k=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;f=this.chart.plotArea.y1;l=this.chart.plotArea.y2;this.bounds={x1:b-n/2,y1:f,x2:e+n/2,y2:l};C=!1;if(this.parent.labels)for(p=Math.ceil(this.parent.interval),
...
h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?za(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?da(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);
...
for(w=0;w<this.parent.dataSeries.length;w++)(t=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=t.index&&(t.dataSeries=this.parent.dataSeries[w],null!==t.dataPoint.y&&t.dataSeries.visible&&p.push(t));if(0===p.length)return;p.sort(function(a,b){return a.distance-b.distance});w=0;if("rangeColumn"===p[0].dataSeries.type||"rangeArea"===p[0].dataSeries.type||"error"===p[0].dataSeries.type||"rangeSplineArea"===p[0].dataSeries.type||"candlestick"===p[0].dataSeries.type||"ohlc"===p[0].dataSeries.type||
"boxAndWhisker"===p[0].dataSeries.type)for(t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y[0])),v=s=0;v<p.length;v++)if(p[v].dataPoint.y&&p[v].dataPoint.y.length)for(x=0;x<p[v].dataPoint.y.length;x++)s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y[x])),s<t&&(t=s,w=v);else s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y)),s<t&&(t=s,w=v);else if("stackedColumn"===p[0].dataSeries.type||"stackedArea"===p[0].dataSeries.type)for(t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y)),
v=y=s=0;v<p.length;v++)if(p[v].dataPoint.y&&p[v].dataPoint.y.length)for(x=0;x<p[v].dataPoint.y.length;x++)s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y[x])),s<t&&(t=s,w=v);else y+=p[v].dataPoint.y,s=Math.abs(d-this.parent.convertValueToPixel(y)),s<t&&(t=s,w=v);else if("stackedColumn100"===p[0].dataSeries.type||"stackedArea100"===p[0].dataSeries.type)for(t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y)),v=C=y=s=0;v<p.length;v++)if(p[v].dataPoint.y&&p[v].dataPoint.y.length)for(x=
0;x<p[v].dataPoint.y.length;x++)s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y[x])),s<t&&(t=s,w=v);else y+=p[v].dataPoint.y,C=p[v].dataPoint.x.getTime?p[v].dataPoint.x.getTime():p[v].dataPoint.x,C=100*(y/p[v].dataSeries.plotUnit.dataPointYSums[C]),s=Math.abs(d-this.parent.convertValueToPixel(C)),s<t&&(t=s,w=v);else for(t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y)),v=s=0;v<p.length;v++)if(p[v].dataPoint.y&&p[v].dataPoint.y.length)for(x=0;x<p[v].dataPoint.y.length;x++)s=
Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y[x])),s<t&&(t=s,w=v);else s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y)),s<t&&(t=s,w=v);x=p[w];b=0;if("rangeColumn"===this.parent.dataSeries[w].type||"rangeArea"===this.parent.dataSeries[w].type||"error"===this.parent.dataSeries[w].type||"rangeSplineArea"===this.parent.dataSeries[w].type||"candlestick"===this.parent.dataSeries[w].type||"ohlc"===this.parent.dataSeries[w].type||"boxAndWhisker"===this.parent.dataSeries[w].type){t=
Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[0]));for(v=s=0;v<x.dataPoint.y.length;v++)s=Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[v])),s<t&&(t=s,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):r(this.options.label)?da(c?c:x.dataPoint.y[b],this.valueFormatString,
this.chart._cultureInfo):this.label;this.value=x.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[w].type||"stackedArea"===this.parent.dataSeries[w].type){t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y));y=s=0;for(v=w;0<=v;v--)y+=p[v].dataPoint.y,s=Math.abs(d-this.parent.convertValueToPixel(y)),s<t&&(t=s,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):r(this.options.label)?da(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=y}else if("stackedColumn100"===this.parent.dataSeries[w].type||"stackedArea100"===this.parent.dataSeries[w].type){t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y));y=s=0;for(v=w;0<=v;v--)y+=p[v].dataPoint.y,C=p[v].dataPoint.x.getTime?p[v].dataPoint.x.getTime():p[v].dataPoint.x,C=100*(y/p[v].dataSeries.plotUnit.dataPointYSums[C]),
s=Math.abs(d-this.parent.convertValueToPixel(C)),s<t&&(t=s,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:C}):r(this.options.label)?da(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=C}else"waterfall"===this.parent.dataSeries[w].type?(m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<
0)+0.5:this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum}):r(this.options.label)?da(c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataSeries.dataPointEOs[x.index].cumulativeSum):(m=1===q.lineWidth%2?(r(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<
0)+0.5:r(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):r(this.options.label)?da(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataPoint.y);f=l=m;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-n/2,x2:e,y2:l+n/2};h.y=l+h.fontSize/2-h.measureText().height/2+2;h.y-h.fontSize/2<this.chart.bounds.y1?
...
2?(d<<0)+0.5:d<<0,b=this.chart.plotArea.x1,e=this.chart.plotArea.x2,this.bounds={x1:b,y1:f-n/2,x2:e,y2:l+n/2};if("xySwapped"===this.chart.plotInfo.axisPlacement)if("left"===this.parent._position||"right"===this.parent._position){C=!1;if(this.parent.labels)for(p=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=p)if(this.parent.labels[v])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({y:d}),t=null,w=0;w<this.parent.dataSeries.length;w++)(t=
this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=t.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):r(this.options.label)?t.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):r(this.options.label)?za(c?
c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):r(this.options.label)?da(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label);h.y=d+h.fontSize/2-h.measureText().height/2+2;h.y-h.fontSize/2<this.chart.bounds.y1?h.y=
...
value:c?c:this.parent.convertPixelToValue(a)}):r(this.options.label)?da(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label,h.x=b-h.measureText().width/2,h.x+h.width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.width),h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1),"bottom"===this.parent._position?h.y=this.parent.lineCoordinates.y2+h.fontSize/2+2:"top"===this.parent._position&&(h.y=this.parent.lineCoordinates.y1-h.height+h.fontSize/2+2)}else if("bottom"===
this.parent._position||"top"===this.parent._position){C=!1;p="";if(this.parent.labels)for(p=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=p)if(this.parent.labels[v])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({x:a}),t=null,w=0;w<this.parent.dataSeries.length;w++)(t=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=t.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:c?c:this.parent.convertPixelToValue(a)}):r(this.options.label)?c?c:t.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):r(this.options.label)?za(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):""}):r(this.options.label)?da(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label);h.x=b-h.measureText().width/2;h.x+h.width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.width);h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1);"bottom"===this.parent._position?h.y=this.parent.lineCoordinates.y2+h.fontSize/2+2:"top"===this.parent._position&&
(h.y=this.parent.lineCoordinates.y1-h.height+h.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position)h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):r(this.options.label)?da(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label,h.y=d+h.fontSize/2-h.measureText().height/2+2,h.y-h.fontSize/2<this.chart.bounds.y1?h.y=
...
"top"===this.parent._position?this.parent.convertPixelToValue(a):this.parent.convertPixelToValue(d)}if("bottom"===this.parent._position||"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(k);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(m);q.globalAlpha=g};na(W,U);W.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");
...
for(b=0;b<k.length;b++)k[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(k[b]);k=null}else{if(h=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=h.dataPointIndex,this.currentSeriesIndex=h.dataSeries.index;else if(t)if(h=Za(a,d,this.chart._eventManager.ghostCtx),0<h&&"undefined"!==typeof this.chart._eventManager.objectMap[h]){h=this.chart._eventManager.objectMap[h];if("legendItem"===h.objectType)return;this.currentSeriesIndex=h.dataSeriesIndex;this.currentDataPointIndex=0<=
...
this.fontWeight?this.fontWeight:"normal",this.contentDiv.style.fontStyle=this.fontStyle?this.fontStyle:t?"italic":"normal"}catch(n){}"pie"===f[0].dataSeries.type||"doughnut"===f[0].dataSeries.type||"funnel"===f[0].dataSeries.type||"pyramid"===f[0].dataSeries.type||"bar"===f[0].dataSeries.type||"rangeBar"===f[0].dataSeries.type||"stackedBar"===f[0].dataSeries.type||"stackedBar100"===f[0].dataSeries.type?a=a-10-this.container.clientWidth:(a=f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x)-
